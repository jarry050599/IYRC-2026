...
typedef enum
{
  HAL_DCACHE_STATE_RESET   = 0x00U,
  HAL_DCACHE_STATE_READY   = 0x01U,
  HAL_DCACHE_STATE_BUSY    = 0x02U,
  HAL_DCACHE_STATE_TIMEOUT = 0x05U,
  HAL_DCACHE_STATE_ERROR   = 0x06U,
...
{
  DCACHE_TypeDef         *Instance;
  DCACHE_InitTypeDef      Init;
...
typedef enum
{
  HAL_DCACHE_CLEAN_BY_ADDRESS_CB_ID                 = 0x00U,
  HAL_DCACHE_INVALIDATE_BY_ADDRESS_CB_ID            = 0x01U,
  HAL_DCACHE_CLEAN_AND_INVALIDATE_BY_ADDRESS_CB_ID  = 0x02U,
  HAL_DCACHE_INVALIDATE_COMPLETE_CB_ID              = 0x03U,
  HAL_DCACHE_ERROR_CB_ID                            = 0x04U,

  HAL_DCACHE_MSPINIT_CB_ID                          = 0x05U,
  HAL_DCACHE_MSPDEINIT_CB_ID                        = 0x06U
...
/** @defgroup DCACHE_Error_Code DCACHE Error Code
  * @{
  */
#define HAL_DCACHE_ERROR_NONE              0x00000000U
#define HAL_DCACHE_ERROR_TIMEOUT           0x00000010U
#define HAL_DCACHE_ERROR_INVALID_CALLBACK  0x00000020U
#define HAL_DCACHE_ERROR_EVICTION_CLEAN    0x00000040U
#define HAL_DCACHE_ERROR_INVALID_OPERATION 0x00000080U
...
/** @defgroup DCACHE_Monitor_Type Monitor type
  * @{
  */
#define DCACHE_MONITOR_READ_HIT        DCACHE_CR_RHITMEN
#define DCACHE_MONITOR_READ_MISS       DCACHE_CR_RMISSMEN
#define DCACHE_MONITOR_WRITE_HIT       DCACHE_CR_WHITMEN
#define DCACHE_MONITOR_WRITE_MISS      DCACHE_CR_WMISSMEN
...
/** @defgroup DCACHE_Read_Burst_Type Remapped Output burst type
  * @{
  */
#define DCACHE_READ_BURST_WRAP         0U
#define DCACHE_READ_BURST_INCR         DCACHE_CR_HBURST
/**
  * @}
  */
...
/** @defgroup DCACHE_Interrupts Interrupts
  * @{
  */
#define DCACHE_IT_BUSYEND              DCACHE_IER_BSYENDIE
#define DCACHE_IT_ERROR                DCACHE_IER_ERRIE
#define DCACHE_IT_CMDEND               DCACHE_IER_CMDENDIE
/**
  * @}
  */
...
/** @defgroup DCACHE_Flags Flags
  * @{
  */
#define DCACHE_FLAG_BUSY               DCACHE_SR_BUSYF
#define DCACHE_FLAG_BUSYEND            DCACHE_SR_BSYENDF
#define DCACHE_FLAG_ERROR              DCACHE_SR_ERRF
#define DCACHE_FLAG_BUSYCMD            DCACHE_SR_BUSYCMDF
#define DCACHE_FLAG_CMDEND             DCACHE_SR_CMDENDF
/**
  * @}
  */
