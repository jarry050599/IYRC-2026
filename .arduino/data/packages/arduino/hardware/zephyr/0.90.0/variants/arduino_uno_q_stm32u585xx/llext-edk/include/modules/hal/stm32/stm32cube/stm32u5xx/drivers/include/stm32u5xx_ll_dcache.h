...
/** @defgroup DCACHE_Read_Burst_Type Remapped Output burst type
  * @{
  */
#define LL_DCACHE_READ_BURST_WRAP         0U
#define LL_DCACHE_READ_BURST_INCR         DCACHE_CR_HBURST
/**
  * @}
  */
...
/** @defgroup DCACHE_LL_EC_GET_FLAG Get Flags Defines
  ...
  * @{
  */
#define LL_DCACHE_SR_ERRF              DCACHE_SR_ERRF
#define LL_DCACHE_SR_BUSYF             DCACHE_SR_BUSYF
#define LL_DCACHE_SR_CMDENDF           DCACHE_SR_CMDENDF
#define LL_DCACHE_SR_BSYENDF           DCACHE_SR_BSYENDF
#define LL_DCACHE_SR_BUSYCMDF          DCACHE_SR_BUSYCMDF
/**
  * @}
  */
...
/** @defgroup DCACHE_LL_EC_CLEAR_FLAG Clear Flags Defines
  ...
  * @{
  */
#define LL_DCACHE_FCR_CERRF            DCACHE_FCR_CERRF
#define LL_DCACHE_FCR_CBSYENDF         DCACHE_FCR_CBSYENDF
#define LL_DCACHE_FCR_CCMDENDF         DCACHE_FCR_CCMDENDF
/**
  * @}
  */
...
/** @defgroup DCACHE_LL_EC_IT IT Defines
  ...
  * @{
  */
#define LL_DCACHE_IER_BSYENDIE         DCACHE_IER_BSYENDIE
#define LL_DCACHE_IER_ERRIE            DCACHE_IER_ERRIE
#define LL_DCACHE_IER_CMDENDIE         DCACHE_IER_CMDENDIE
/**
  * @}
  */
...
/** @defgroup DCACHE_Monitor_Type Monitor type
  * @{
  */
#define LL_DCACHE_MONITOR_READ_HIT        DCACHE_CR_RHITMEN
#define LL_DCACHE_MONITOR_READ_MISS       DCACHE_CR_RMISSMEN
#define LL_DCACHE_MONITOR_WRITE_HIT       DCACHE_CR_WHITMEN
#define LL_DCACHE_MONITOR_WRITE_MISS      DCACHE_CR_WMISSMEN
