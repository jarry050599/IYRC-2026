...
/** @defgroup FLASH_Flags FLASH Flags Definition
  ...
  */
#if defined (__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
#define FLASH_FLAG_EOP       FLASH_SECSR_EOP
#define FLASH_FLAG_OPERR     FLASH_SECSR_OPERR
#define FLASH_FLAG_PROGERR   FLASH_SECSR_PROGERR
#define FLASH_FLAG_WRPERR    FLASH_SECSR_WRPERR
#define FLASH_FLAG_PGAERR    FLASH_SECSR_PGAERR
#define FLASH_FLAG_SIZERR    FLASH_SECSR_SIZERR
#define FLASH_FLAG_PGSERR    FLASH_SECSR_PGSERR
#define FLASH_FLAG_OPTWERR   FLASH_NSSR_OPTWERR
#define FLASH_FLAG_BSY       FLASH_SECSR_BSY
#define FLASH_FLAG_WDW       FLASH_SECSR_WDW
...
/** @defgroup FLASH_Interrupt_definition FLASH Interrupts Definition
  ...
  */
#if defined (__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
#define FLASH_IT_EOP     FLASH_SECCR_EOPIE
#define FLASH_IT_OPERR   FLASH_SECCR_ERRIE
...
#if defined (__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
#define OPTIONBYTE_WMSEC          0x00000010U
#define OPTIONBYTE_BOOT_LOCK      0x00000020U
#endif /* __ARM_FEATURE_CMSE */
...
#define OB_USER_SRAM_RST          0x00000010U
...
#define OB_BOOT_LOCK_ENABLE    FLASH_SECBOOTADD0R_BOOT_LOCK
/**
  * @}
  */
...
/** @defgroup FLASH_OB_WMSEC FLASH Option Bytes Watermarked-based security configuration
  * @{
  */
#define OB_WMSEC_AREA1                 FLASH_BANK_1
#define OB_WMSEC_AREA2                 FLASH_BANK_2

#define OB_WMSEC_SECURE_AREA_CONFIG    0x00000010U
#define OB_WMSEC_HDP_AREA_CONFIG       0x00000020U
#define OB_WMSEC_HDP_AREA_ENABLE       0x00000080U
#define OB_WMSEC_HDP_AREA_DISABLE      0x00000100U
/**
  * @}
  */
#endif /* __ARM_FEATURE_CMSE */
...
#if defined (__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
#define OB_BOOTADDR_SEC0     0x00000004U
#endif /* __ARM_FEATURE_CMSE */
/**
  * @}
  */
