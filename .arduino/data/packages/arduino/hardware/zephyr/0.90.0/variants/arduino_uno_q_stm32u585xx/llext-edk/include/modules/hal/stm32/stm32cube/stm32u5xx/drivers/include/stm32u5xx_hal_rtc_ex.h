...
/** @defgroup RTCEx_Smooth_calib_low_power_Definitions RTCEx Smooth calib Low Power Definitions
  * @{
  */
#define RTC_LPCAL_SET                      RTC_CALR_LPCAL
...
/** @defgroup RTCEx_Tamper_Trigger  RTCEx Tamper Trigger
  * @{
  */
#define RTC_TAMPERTRIGGER_RISINGEDGE       0U
#define RTC_TAMPERTRIGGER_FALLINGEDGE      1U
#define RTC_TAMPERTRIGGER_LOWLEVEL         2U
#define RTC_TAMPERTRIGGER_HIGHLEVEL        3U
/**
  * @}
  */
...
/** @defgroup RTCEx_Tamper_Sampling_Frequencies  RTCEx Tamper Sampling Frequencies
  * @{
  */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV32768  0U
...
/** @defgroup RTCEx_Tamper_Pull_UP  RTCEx Tamper Pull UP
  * @{
  */
#define RTC_TAMPER_PULLUP_ENABLE           0U
...
/** @defgroup RTCEx_Tamper_TimeStampOnTamperDetection RTCEx Tamper TimeStamp On Tamper Detection Definitions
  * @{
  */
#define RTC_TIMESTAMPONTAMPERDETECTION_DISABLE  0U
...
#define RTC_IT_TAMP_4                      TAMP_IER_TAMP4IE
#define RTC_IT_TAMP_5                      TAMP_IER_TAMP5IE
#define RTC_IT_TAMP_6                      TAMP_IER_TAMP6IE
#define RTC_IT_TAMP_7                      TAMP_IER_TAMP7IE
#define RTC_IT_TAMP_8                      TAMP_IER_TAMP8IE
...
#define RTC_IT_INT_TAMP_9                   TAMP_IER_ITAMP9IE
#define RTC_IT_INT_TAMP_11                  TAMP_IER_ITAMP11IE
#define RTC_IT_INT_TAMP_12                  TAMP_IER_ITAMP9IE
#define RTC_IT_INT_TAMP_13                  TAMP_IER_ITAMP11IE
...
#define RTC_ATAMP_ASYNCPRES_RTCCLK_2048  (TAMP_ATCR1_ATCKSEL_3 | TAMP_ATCR1_ATCKSEL_1 | TAMP_ATCR1_ATCKSEL_0)
/**
  * @}
  */
...
/** @defgroup RTCEx_Binary_Mode RTC Binary Mode (32-bit free-running counter configuration).
  ...
  * @{
  */
#define RTC_BINARY_NONE                    0U
#define RTC_BINARY_ONLY                    RTC_ICSR_BIN_0
#define RTC_BINARY_MIX                     RTC_ICSR_BIN_1
/**
  * @}
  */
...
/** @defgroup RTCEx_Binary_mix_BCDU If Binary mode is RTC_BINARY_MIX, the BCD calendar second is incremented
  ...
  * @{
  */
#define RTC_BINARY_MIX_BCDU_0              0U
#define RTC_BINARY_MIX_BCDU_1              (0x1UL << RTC_ICSR_BCDU_Pos)
#define RTC_BINARY_MIX_BCDU_2              (0x2UL << RTC_ICSR_BCDU_Pos)
#define RTC_BINARY_MIX_BCDU_3              (0x3UL << RTC_ICSR_BCDU_Pos)
#define RTC_BINARY_MIX_BCDU_4              (0x4UL << RTC_ICSR_BCDU_Pos)
#define RTC_BINARY_MIX_BCDU_5              (0x5UL << RTC_ICSR_BCDU_Pos)
#define RTC_BINARY_MIX_BCDU_6              (0x6UL << RTC_ICSR_BCDU_Pos)
#define RTC_BINARY_MIX_BCDU_7              (0x7UL << RTC_ICSR_BCDU_Pos)
/**
  * @}
  */
...
/** @defgroup RTCEx_Alarm_Sub_Seconds_binary_Masks_Definitions RTC Alarm Sub Seconds with binary mode Masks Definitions
  * @{
  */
#define RTC_ALARMSUBSECONDBINMASK_ALL           0U
...
/** @defgroup RTCEx_RTC_Secure_Full  RTCEx Secure Definition
  * @{
  */
#define RTC_SECURE_FULL_YES                 RTC_SECCFGR_SEC
#define RTC_SECURE_FULL_NO                  0U
/**
  * @}
  */
...
#define RTC_NONSECURE_FEATURE_INIT            ~RTC_SECCFGR_INITSEC
#define RTC_NONSECURE_FEATURE_CAL             ~RTC_SECCFGR_CALSEC
#define RTC_NONSECURE_FEATURE_TS              ~RTC_SECCFGR_TSSEC
#define RTC_NONSECURE_FEATURE_WUT             ~RTC_SECCFGR_WUTSEC
#define RTC_NONSECURE_FEATURE_ALRA            ~RTC_SECCFGR_ALRASEC
#define RTC_NONSECURE_FEATURE_ALRB            ~RTC_SECCFGR_ALRBSEC
...
/** @defgroup RTCEx_TAMP_Secure_Full  RTCEx TAMP Secure Definition
  * @{
  */
#define TAMP_SECURE_FULL_YES                 TAMP_SECCFGR_TAMPSEC
#define TAMP_SECURE_FULL_NO                  0U
/**
  * @}
  */
...
/** @defgroup RTCEx_TAMP_Monotonic_Counter_Secure  RTCEx TAMP Monotonic Counter Secure Definition
  * @{
  */
#define TAMP_MONOTONIC_CNT_SECURE_YES                 TAMP_SECCFGR_CNT1SEC
#define TAMP_MONOTONIC_CNT_SECURE_NO                  0U
/**
  * @}
  */
...
#define RTC_PRIVILEGE_FEATURE_INIT           RTC_PRIVCFGR_INITPRIV
#define RTC_PRIVILEGE_FEATURE_CAL            RTC_PRIVCFGR_CALPRIV
#define RTC_PRIVILEGE_FEATURE_TS             RTC_PRIVCFGR_TSPRIV
#define RTC_PRIVILEGE_FEATURE_WUT            RTC_PRIVCFGR_WUTPRIV
#define RTC_PRIVILEGE_FEATURE_ALRA           RTC_PRIVCFGR_ALRAPRIV
#define RTC_PRIVILEGE_FEATURE_ALRB           RTC_PRIVCFGR_ALRBPRIV
