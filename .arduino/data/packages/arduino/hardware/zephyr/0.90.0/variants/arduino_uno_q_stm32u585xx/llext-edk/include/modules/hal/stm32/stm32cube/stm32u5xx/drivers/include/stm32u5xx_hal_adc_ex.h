...
#define ADC_EXTERNALTRIGINJEC_LPTIM1_CH2   (LL_ADC_INJ_TRIG_EXT_LPTIM1_CH2)
#define ADC_EXTERNALTRIGINJEC_LPTIM2_CH2   (LL_ADC_INJ_TRIG_EXT_LPTIM2_CH2)
#define ADC_EXTERNALTRIGINJEC_LPTIM3_CH1   (LL_ADC_INJ_TRIG_EXT_LPTIM3_CH1)
#define ADC_EXTERNALTRIGINJEC_LPTIM4_OUT   (LL_ADC_INJ_TRIG_EXT_LPTIM4_OUT)
/**
  * @}
  */
...
/** @defgroup ADCEx_OffsetSign ADC Extended Offset Sign
  * @{
  */
#define ADC_OFFSET_SIGN_NEGATIVE      LL_ADC_OFFSET_SIGN_NEGATIVE
#define ADC_OFFSET_SIGN_POSITIVE      LL_ADC_OFFSET_SIGN_POSITIVE
/**
  * @}
  */
...
#define ADC_TWOSAMPLINGDELAY_13CYCLES      (LL_ADC_MULTI_TWOSMP_DELAY_13CYCLES)
#define ADC_TWOSAMPLINGDELAY_14CYCLES      (LL_ADC_MULTI_TWOSMP_DELAY_14CYCLES)
#define ADC_TWOSAMPLINGDELAY_15CYCLES      (LL_ADC_MULTI_TWOSMP_DELAY_15CYCLES)
#define ADC_TWOSAMPLINGDELAY_16CYCLES      (LL_ADC_MULTI_TWOSMP_DELAY_16CYCLES)
