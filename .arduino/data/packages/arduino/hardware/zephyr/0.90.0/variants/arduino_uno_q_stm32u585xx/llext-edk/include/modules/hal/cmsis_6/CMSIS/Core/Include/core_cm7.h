...
#define DWT_FUNCTION_LNK1ENA_Msk           (1UL << DWT_FUNCTION_LNK1ENA_Pos)
...
#define TPIU_FIFO0_ITM_ATVALID_Pos         29U
#define TPIU_FIFO0_ITM_ATVALID_Msk         (1UL << TPIU_FIFO0_ITM_ATVALID_Pos)

#define TPIU_FIFO0_ITM_bytecount_Pos       27U
#define TPIU_FIFO0_ITM_bytecount_Msk       (0x3UL << TPIU_FIFO0_ITM_bytecount_Pos)

#define TPIU_FIFO0_ETM_ATVALID_Pos         26U
#define TPIU_FIFO0_ETM_ATVALID_Msk         (1UL << TPIU_FIFO0_ETM_ATVALID_Pos)

#define TPIU_FIFO0_ETM_bytecount_Pos       24U
#define TPIU_FIFO0_ETM_bytecount_Msk       (0x3UL << TPIU_FIFO0_ETM_bytecount_Pos)

#define TPIU_FIFO0_ETM2_Pos                16U
#define TPIU_FIFO0_ETM2_Msk                (0xFFUL << TPIU_FIFO0_ETM2_Pos)

#define TPIU_FIFO0_ETM1_Pos                 8U
#define TPIU_FIFO0_ETM1_Msk                (0xFFUL << TPIU_FIFO0_ETM1_Pos)

#define TPIU_FIFO0_ETM0_Pos                 0U
#define TPIU_FIFO0_ETM0_Msk                (0xFFUL)

/** \brief TPIU ITATBCTR2 Register Definitions */
#define TPIU_ITATBCTR2_ATREADY2_Pos         0U
#define TPIU_ITATBCTR2_ATREADY2_Msk        (1UL)

#define TPIU_ITATBCTR2_ATREADY1_Pos         0U
#define TPIU_ITATBCTR2_ATREADY1_Msk        (1UL)

/** \brief TPIU Integration ITM Data Register Definitions (FIFO1) */
#define TPIU_FIFO1_ITM_ATVALID_Pos         29U
#define TPIU_FIFO1_ITM_ATVALID_Msk         (1UL << TPIU_FIFO1_ITM_ATVALID_Pos)

#define TPIU_FIFO1_ITM_bytecount_Pos       27U
#define TPIU_FIFO1_ITM_bytecount_Msk       (0x3UL << TPIU_FIFO1_ITM_bytecount_Pos)

#define TPIU_FIFO1_ETM_ATVALID_Pos         26U
#define TPIU_FIFO1_ETM_ATVALID_Msk         (1UL << TPIU_FIFO1_ETM_ATVALID_Pos)

#define TPIU_FIFO1_ETM_bytecount_Pos       24U
#define TPIU_FIFO1_ETM_bytecount_Msk       (0x3UL << TPIU_FIFO1_ETM_bytecount_Pos)

#define TPIU_FIFO1_ITM2_Pos                16U
#define TPIU_FIFO1_ITM2_Msk                (0xFFUL << TPIU_FIFO1_ITM2_Pos)

#define TPIU_FIFO1_ITM1_Pos                 8U
#define TPIU_FIFO1_ITM1_Msk                (0xFFUL << TPIU_FIFO1_ITM1_Pos)

#define TPIU_FIFO1_ITM0_Pos                 0U
#define TPIU_FIFO1_ITM0_Msk                (0xFFUL)

/** \brief TPIU ITATBCTR0 Register Definitions */
#define TPIU_ITATBCTR0_ATREADY2_Pos         0U
#define TPIU_ITATBCTR0_ATREADY2_Msk        (1UL)

#define TPIU_ITATBCTR0_ATREADY1_Pos         0U
#define TPIU_ITATBCTR0_ATREADY1_Msk        (1UL)
...
#define TPIU_DEVID_MinBufSz_Pos             6U
#define TPIU_DEVID_MinBufSz_Msk            (0x7UL << TPIU_DEVID_MinBufSz_Pos)

#define TPIU_DEVID_AsynClkIn_Pos            5U
#define TPIU_DEVID_AsynClkIn_Msk           (1UL << TPIU_DEVID_AsynClkIn_Pos)
