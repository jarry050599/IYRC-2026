...
#define COMP_POWERMODE_ULTRALOWPOWER   (COMP_CSR_PWRMODE_1 | COMP_CSR_PWRMODE_0)
/**
  * @}
  */
...
#define COMP_INPUT_PLUS_IO4 (COMP_CSR_INPSEL_1 | COMP_CSR_INPSEL_0)
#define COMP_INPUT_PLUS_IO5 (COMP_CSR_INPSEL_2)
#define COMP_INPUT_PLUS_IO6 (COMP_CSR_INPSEL_2 | COMP_CSR_INPSEL_0)
...
/** @defgroup COMP_InputMinus COMP input minus (inverting input)
  * @{
  */
#define COMP_INPUT_MINUS_1_4VREFINT    (0x00000000UL)
#define COMP_INPUT_MINUS_1_2VREFINT    (                                                            COMP_CSR_INMSEL_0)
#define COMP_INPUT_MINUS_3_4VREFINT    (                                        COMP_CSR_INMSEL_1                    )
#define COMP_INPUT_MINUS_VREFINT       (                                        COMP_CSR_INMSEL_1 | COMP_CSR_INMSEL_0)
...
#define COMP_BLANKINGSRC_TIM3_OC3        (COMP_CSR_BLANKSEL_2)
#define COMP_BLANKINGSRC_TIM3_OC4        (COMP_CSR_BLANKSEL_0)
#define COMP_BLANKINGSRC_TIM8_OC5        (COMP_CSR_BLANKSEL_1)
#define COMP_BLANKINGSRC_TIM15_OC1       (COMP_CSR_BLANKSEL_2)
/**
  * @}
  */
...
/** @defgroup COMP_WindowMode_Instance_Differentiator COMP window mode instance differentiator
  * @{
  */
#define COMP_WINDOWMODE_COMP2          0x00001000U
/**
  * @}
  */
...
/** @defgroup COMP_ExtiLine COMP EXTI Lines
  * @{
  */
#define COMP_EXTI_LINE_COMP1           (EXTI_IMR1_IM17)
#if defined(COMP2)
#define COMP_EXTI_LINE_COMP2           (EXTI_IMR1_IM18)
#endif /* COMP2 */
/**
  * @}
  */
