...
/** @defgroup GFXMMU_AddressCacheLockBuffer GFXMMU address cache lock buffer
  *  @{
 */
#define GFXMMU_ADDRESSCACHE_LOCK_BUFFER0 0x00000000U
#define GFXMMU_ADDRESSCACHE_LOCK_BUFFER1 GFXMMU_CR_ACLB_0
#define GFXMMU_ADDRESSCACHE_LOCK_BUFFER2 GFXMMU_CR_ACLB_1
#define GFXMMU_ADDRESSCACHE_LOCK_BUFFER3 GFXMMU_CR_ACLB
/**
  * @}
  */
