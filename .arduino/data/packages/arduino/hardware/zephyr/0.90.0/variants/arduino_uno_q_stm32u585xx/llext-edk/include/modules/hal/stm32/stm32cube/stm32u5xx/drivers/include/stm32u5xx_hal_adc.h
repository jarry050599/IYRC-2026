...
#endif /* USE_HAL_ADC_REGISTER_CALLBACKS */
{
  ...
  void (* CalibrationCpltCallback)(struct  __ADC_HandleTypeDef *hadc);
  void (* VoltageRegulatorCallback)(struct   __ADC_HandleTypeDef *hadc);
  void (* ADCReadyCallback)(struct   __ADC_HandleTypeDef *hadc);
...
typedef enum
{
  ...
  HAL_ADC_END_OF_CALIBRATION_CB_ID      = 0x09U,
  HAL_ADC_VOLTAGE_REGULATOR_CB_ID       = 0x0AU,
  HAL_ADC_ADC_READY_CB_ID               = 0x0BU,
  HAL_ADC_MSPINIT_CB_ID                 = 0x0CU,
  HAL_ADC_MSPDEINIT_CB_ID               = 0x0DU
...
#define ADC4_SCAN_DISABLE               (0x00000000UL)
#define ADC4_SCAN_ENABLE                (ADC4_CFGR1_CHSELRMOD)


#define ADC_SCAN_SEQ_FIXED              (ADC4_SCAN_SEQ_FIXED_INT)
#define ADC_SCAN_SEQ_FIXED_BACKWARD     (ADC4_SCAN_SEQ_FIXED_INT | ADC4_CFGR1_SCANDIR)

#define ADC_SCAN_DIRECTION_FORWARD      (ADC_SCAN_SEQ_FIXED)
#define ADC_SCAN_DIRECTION_BACKWARD     (ADC_SCAN_SEQ_FIXED_BACKWARD)
...
/** @defgroup ADC_HAL_LowPower_DPD ADC low power and deep power down selection
  * @{
  */
#define ADC_LOW_POWER_NONE              (0x00000000UL)
#define ADC_LOW_POWER_AUTOFF            (ADC4_PWRR_AUTOFF)
#define ADC_LOW_POWER_DPD               (ADC4_PWRR_DPD)
#define ADC_LOW_POWER_AUTOFF_DPD        (ADC4_PWRR_AUTOFF | ADC4_PWRR_DPD)
/**
  * @}
  */
...
/** @defgroup ADC_HAL_VrefProt ADC VREF+ protection mode selection
  * @{
  */
#define ADC_VREF_PPROT_NONE              (0x00000000UL)
#define ADC_VREF_PPROT_VREFPROT          (ADC4_PWRR_VREFPROT)
#define ADC_VREF_PPROT_VREFSECSMP        (ADC4_PWRR_VREFSECSMP)
#define ADC_VREF_PPROT_VREF_VREFSECSMP   (ADC4_PWRR_VREFPROT | ADC4_PWRR_VREFSECSMP)
/**
  * @}
  */
...
#define ADC_EXTERNALTRIG_LPTIM1_CH1   (LL_ADC_REG_TRIG_EXT_LPTIM1_CH1)
#define ADC_EXTERNALTRIG_LPTIM2_CH1   (LL_ADC_REG_TRIG_EXT_LPTIM2_CH1)
#define ADC_EXTERNALTRIG_LPTIM3_CH1   (LL_ADC_REG_TRIG_EXT_LPTIM3_CH1)
#define ADC_EXTERNALTRIG_LPTIM4_OUT   (LL_ADC_REG_TRIG_EXT_LPTIM4_OUT)

#define ADC4_EXTERNALTRIG_T1_CC4      (LL_ADC_REG_TRIG_EXT_TIM1_CH4_ADC4)
...
/** @defgroup ADC_HAL_EC_REG_SEQ_RANKS  ADC group regular - Sequencer ranks
  * @{
  */
#define ADC4_RANK_CHANNEL_NUMBER            (0x00000001U)
#define ADC4_RANK_NONE                      (0x00000002U)

#define ADC4_REGULAR_RANK_1                 (LL_ADC_REG_RANK_1_ADC4)
#define ADC4_REGULAR_RANK_2                 (LL_ADC_REG_RANK_2_ADC4)
#define ADC4_REGULAR_RANK_3                 (LL_ADC_REG_RANK_3_ADC4)
#define ADC4_REGULAR_RANK_4                 (LL_ADC_REG_RANK_4_ADC4)
#define ADC4_REGULAR_RANK_5                 (LL_ADC_REG_RANK_5_ADC4)
#define ADC4_REGULAR_RANK_6                 (LL_ADC_REG_RANK_6_ADC4)
#define ADC4_REGULAR_RANK_7                 (LL_ADC_REG_RANK_7_ADC4)
#define ADC4_REGULAR_RANK_8                 (LL_ADC_REG_RANK_8_ADC4)
...
/** @defgroup ADC_HAL_EC_CHANNEL_SAMPLINGTIME  Channel - Sampling time
  * @{
  */
#define ADC_SAMPLETIME_5CYCLES         (LL_ADC_SAMPLINGTIME_5CYCLES)
#define ADC_SAMPLETIME_6CYCLES         (LL_ADC_SAMPLINGTIME_6CYCLES)
#define ADC_SAMPLETIME_12CYCLES        (LL_ADC_SAMPLINGTIME_12CYCLES)
#define ADC_SAMPLETIME_20CYCLES        (LL_ADC_SAMPLINGTIME_20CYCLES)
#define ADC_SAMPLETIME_36CYCLES        (LL_ADC_SAMPLINGTIME_36CYCLES)
#define ADC_SAMPLETIME_68CYCLES        (LL_ADC_SAMPLINGTIME_68CYCLES)
#define ADC_SAMPLETIME_391CYCLES       (LL_ADC_SAMPLINGTIME_391CYCLES)
#define ADC_SAMPLETIME_814CYCLES       (LL_ADC_SAMPLINGTIME_814CYCLES)
/**
  * @}
  */
...
/** @defgroup ADC_HAL_EC_CHANNEL_SAMPLINGTIME  Channel - Sampling time
  * @{
  */
#define ADC4_SAMPLETIME_1CYCLE_5            (LL_ADC4_SAMPLINGTIME_1CYCLE_5)
#define ADC4_SAMPLETIME_3CYCLES_5           (LL_ADC4_SAMPLINGTIME_3CYCLES_5)
#define ADC4_SAMPLETIME_7CYCLES_5           (LL_ADC4_SAMPLINGTIME_7CYCLES_5)
#define ADC4_SAMPLETIME_12CYCLES_5          (LL_ADC4_SAMPLINGTIME_12CYCLES_5)
#define ADC4_SAMPLETIME_19CYCLES_5          (LL_ADC4_SAMPLINGTIME_19CYCLES_5)
#define ADC4_SAMPLETIME_39CYCLES_5          (LL_ADC4_SAMPLINGTIME_39CYCLES_5)
#define ADC4_SAMPLETIME_79CYCLES_5          (LL_ADC4_SAMPLINGTIME_79CYCLES_5)
#define ADC4_SAMPLETIME_814CYCLES_5         (LL_ADC4_SAMPLINGTIME_814CYCLES_5)
/**
  * @}
  */
...
/** @defgroup ADCEx_Calibration_Linearity_Index ADC indexes for linear calibration
  * @{
  */
#define ADC_CALIB_OFFSET_INDEX         LL_ADC_CALIB_OFFSET_INDEX
#define ADC_CALIB_LINEARITY_INDEX1     LL_ADC_CALIB_LINEARITY_INDEX1
#define ADC_CALIB_LINEARITY_INDEX2     LL_ADC_CALIB_LINEARITY_INDEX2
#define ADC_CALIB_LINEARITY_INDEX3     LL_ADC_CALIB_LINEARITY_INDEX3
#define ADC_CALIB_LINEARITY_INDEX4     LL_ADC_CALIB_LINEARITY_INDEX4
#define ADC_CALIB_LINEARITY_INDEX5     LL_ADC_CALIB_LINEARITY_INDEX5
#define ADC_CALIB_LINEARITY_INDEX6     LL_ADC_CALIB_LINEARITY_INDEX6
#define ADC_CALIB_LINEARITY_INDEX7     LL_ADC_CALIB_LINEARITY_INDEX7
#define ADC_CALIB_INTEROFFSET_INDEX    LL_ADC_CALIB_INTEROFFSET_INDEX
/**
  * @}
  */
...
#define ADC_CHANNEL_20                     (LL_ADC_CHANNEL_20)
#define ADC_CHANNEL_21                     (LL_ADC_CHANNEL_21)
#define ADC_CHANNEL_22                     (LL_ADC_CHANNEL_22)
#define ADC_CHANNEL_23                     (LL_ADC_CHANNEL_23)
...
#define ADC_CHANNEL_DAC1CH1_ADC4           (LL_ADC_CHANNEL_DAC1CH1_ADC4)
#define ADC_CHANNEL_DAC1CH2_ADC4           (LL_ADC_CHANNEL_DAC1CH2_ADC4)

#define ADC4_CHANNEL_TEMPSENSOR            (LL_ADC_CHANNEL_TEMPSENSOR_ADC4)
#define ADC4_CHANNEL_VBAT                  (LL_ADC_CHANNEL_VBAT_ADC4)

#define ADC_CHANNEL_VCORE                  (LL_ADC_CHANNEL_VCORE)
...
#define ADC_CONVERSIONDATA_MDF                 ((uint32_t)ADC_CFGR1_DMNGT_1)
#define ADC_CONVERSIONDATA_DMA_ONESHOT         ((uint32_t)ADC_CFGR1_DMNGT_0)
#define ADC_CONVERSIONDATA_DMA_CIRCULAR        ((uint32_t)(ADC_CFGR1_DMNGT_0 | ADC_CFGR1_DMNGT_1))
/**
  * @}
  */
...
#define ADC_AWD_FILTERING_2SAMPLES      ((ADC_HTR_AWDFILT_0))
#define ADC_AWD_FILTERING_3SAMPLES      ((ADC_HTR_AWDFILT_1))
#define ADC_AWD_FILTERING_4SAMPLES      ((ADC_HTR_AWDFILT_1 | ADC_HTR_AWDFILT_0))
#define ADC_AWD_FILTERING_5SAMPLES      ((ADC_HTR_AWDFILT_2))
#define ADC_AWD_FILTERING_6SAMPLES      ((ADC_HTR_AWDFILT_2 | ADC_HTR_AWDFILT_0))
#define ADC_AWD_FILTERING_7SAMPLES      ((ADC_HTR_AWDFILT_2 | ADC_HTR_AWDFILT_1))
#define ADC_AWD_FILTERING_8SAMPLES      ((ADC_HTR_AWDFILT_2 | ADC_HTR_AWDFILT_1 | ADC_HTR_AWDFILT_0))
/**
  * @}
  */
...
#define ADC_ANALOGWATCHDOG_SINGLE_INJEC         (ADC_CFGR1_AWD1SGL | ADC_CFGR1_JAWD1EN)
#define ADC_ANALOGWATCHDOG_SINGLE_REGINJEC      (ADC_CFGR1_AWD1SGL | ADC_CFGR1_AWD1EN  | ADC_CFGR1_JAWD1EN)
#define ADC_ANALOGWATCHDOG_ALL_REG              (ADC_CFGR1_AWD1EN)
#define ADC_ANALOGWATCHDOG_ALL_INJEC            (ADC_CFGR1_JAWD1EN)
#define ADC_ANALOGWATCHDOG_ALL_REGINJEC         (ADC_CFGR1_AWD1EN  | ADC_CFGR1_JAWD1EN)
/**
  * @}
  */
...
/** @defgroup ADC_HAL_EC_REG_TRIGGER_FREQ  ADC group regular - Trigger frequency mode
  * @{
  */
#define ADC_TRIGGER_FREQ_HIGH              (LL_ADC_TRIGGER_FREQ_HIGH)
#define ADC_TRIGGER_FREQ_LOW               (LL_ADC_TRIGGER_FREQ_LOW)
/**
  * @}
  */
...
#define ADC_IT_LDORDY        ADC_IER_LDORDYIE
