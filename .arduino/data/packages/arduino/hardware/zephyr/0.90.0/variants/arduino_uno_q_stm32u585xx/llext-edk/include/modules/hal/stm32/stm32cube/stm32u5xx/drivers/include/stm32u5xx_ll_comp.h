...
#define LL_COMP_WINDOWMODE_BITOFFSET_POS   (11UL)
...
#define LL_COMP_WINDOWMODE_COMP1_INPUT_PLUS_COMMON (COMP_CSR_WINMODE | LL_COMP_WINDOWMODE_COMP_EVEN_REGOFFSET_MASK)
#define LL_COMP_WINDOWMODE_COMP2_INPUT_PLUS_COMMON (COMP_CSR_WINMODE | LL_COMP_WINDOWMODE_COMP_ODD_REGOFFSET_MASK)
/**
  * @}
  */
...
/** @defgroup COMP_LL_EC_COMMON_WINDOWOUTPUT Comparator common modes - Window output
  * @{
  */
#define LL_COMP_WINDOWOUTPUT_EACH_COMP               (0x00000000UL)
#define LL_COMP_WINDOWOUTPUT_COMP1                   (COMP_CSR_WINOUT | LL_COMP_WINDOWMODE_COMP_ODD_REGOFFSET_MASK)
#define LL_COMP_WINDOWOUTPUT_COMP2                   (COMP_CSR_WINOUT | LL_COMP_WINDOWMODE_COMP_EVEN_REGOFFSET_MASK)
#define LL_COMP_WINDOWOUTPUT_BOTH                    (COMP_CSR_WINOUT | LL_COMP_WINDOWMODE_COMP_EVEN_REGOFFSET_MASK | LL_COMP_WINDOWOUTPUT_BOTH_SETTING_MASK)
/**
  * @}
  */
...
#define LL_COMP_INPUT_PLUS_IO4         (COMP_CSR_INPSEL_1 | COMP_CSR_INPSEL_0)
#define LL_COMP_INPUT_PLUS_IO5         (COMP_CSR_INPSEL_2)
#define LL_COMP_INPUT_PLUS_IO6         (COMP_CSR_INPSEL_2 | COMP_CSR_INPSEL_0)
...
#define LL_COMP_INPUT_MINUS_1_2VREFINT  (                                                            COMP_CSR_INMSEL_0)
#define LL_COMP_INPUT_MINUS_3_4VREFINT  (                                        COMP_CSR_INMSEL_1                    )
#define LL_COMP_INPUT_MINUS_VREFINT     (                                        COMP_CSR_INMSEL_1 | COMP_CSR_INMSEL_0)
...
#define LL_COMP_BLANKINGSRC_TIM1_OC5        (COMP_CSR_BLANKSEL_0)
#define LL_COMP_BLANKINGSRC_TIM2_OC3        (COMP_CSR_BLANKSEL_1)
#define LL_COMP_BLANKINGSRC_TIM3_OC3        (COMP_CSR_BLANKSEL_2)
#define LL_COMP_BLANKINGSRC_TIM3_OC4        (COMP_CSR_BLANKSEL_0)
#define LL_COMP_BLANKINGSRC_TIM8_OC5        (COMP_CSR_BLANKSEL_1)
#define LL_COMP_BLANKINGSRC_TIM15_OC1       (COMP_CSR_BLANKSEL_2)
/**
  * @}
  */
