...
/** @defgroup SMBUSEx_FastModePlus SMBUS Extended Fast Mode Plus
  * @{
  */
#define SMBUS_FASTMODEPLUS_ENABLE         0x00000000U
#define SMBUS_FASTMODEPLUS_DISABLE        0x00000001U
/**
  * @}
  */
...
/** @defgroup SMBUSEx_AutonomousMode_FunctionalState SMBUS Extended Autonomous Mode State
  * @{
  */
#define SMBUS_AUTO_MODE_DISABLE           (0x00000000U)
#define SMBUS_AUTO_MODE_ENABLE            I2C_AUTOCR_TRIGEN
/**
  * @}
  */
...
/** @defgroup SMBUSEx_AutonomousMode_TriggerSelection SMBUS Extended Autonomous Mode Trigger Selection
  * @{
  */
#define SMBUS_TRIG_GRP1                   (0x10000000U)
#define SMBUS_TRIG_GRP2                   (0x20000000U)
...
/** @defgroup SMBUSEx_AutonomousMode_TriggerPolarity Extended Autonomous Mode Trigger Polarity
  * @{
  */
#define SMBUS_TRIG_POLARITY_RISING        (0x00000000U)
#define SMBUS_TRIG_POLARITY_FALLING       I2C_AUTOCR_TRIGPOL
/**
  * @}
  */
