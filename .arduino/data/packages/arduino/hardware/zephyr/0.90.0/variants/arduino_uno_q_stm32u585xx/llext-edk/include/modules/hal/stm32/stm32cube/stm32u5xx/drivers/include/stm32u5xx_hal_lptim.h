...
typedef enum
{
  HAL_LPTIM_ACTIVE_CHANNEL_1        = 0x01U,
  HAL_LPTIM_ACTIVE_CHANNEL_2        = 0x02U,
  HAL_LPTIM_ACTIVE_CHANNEL_CLEARED  = 0x00U
...
typedef enum
{
  HAL_LPTIM_CHANNEL_STATE_RESET             = 0x00U,
  HAL_LPTIM_CHANNEL_STATE_READY             = 0x01U,
  HAL_LPTIM_CHANNEL_STATE_BUSY              = 0x02U,
...
#endif /* USE_HAL_LPTIM_REGISTER_CALLBACKS */
{
  ...
  HAL_LPTIM_ActiveChannel        Channel;
  ...
  __IO  HAL_LPTIM_ChannelStateTypeDef   ChannelState[2];
  ...
  void (* UpdateEventHalfCpltCallback)(struct __LPTIM_HandleTypeDef *hlptim);
  void (* ErrorCallback)(struct __LPTIM_HandleTypeDef *hlptim);
  void (* IC_CaptureCallback)(struct __LPTIM_HandleTypeDef *hlptim);
  void (* IC_CaptureHalfCpltCallback)(struct __LPTIM_HandleTypeDef *htim);
  void (* IC_OverCaptureCallback)(struct __LPTIM_HandleTypeDef *hlptim);
#endif /* USE_HAL_LPTIM_REGISTER_CALLBACKS */
} LPTIM_HandleTypeDef;
...
typedef enum
{
  ...
  HAL_LPTIM_UPDATE_EVENT_CB_ID      = 0x09U,
  HAL_LPTIM_REP_COUNTER_WRITE_CB_ID = 0x0AU,
  HAL_LPTIM_UPDATE_EVENT_HALF_CB_ID = 0x0BU,
  HAL_LPTIM_ERROR_CB_ID             = 0x0CU,
  HAL_LPTIM_IC_CAPTURE_CB_ID        = 0x0DU,
  HAL_LPTIM_IC_CAPTURE_HALF_CB_ID   = 0x0EU,
  HAL_LPTIM_OVER_CAPTURE_CB_ID      = 0x0FU,
...
/** @defgroup LPTIM_DMA_sources LPTIM DMA Sources
  * @{
  */
#define LPTIM_DMA_UPDATE                     LPTIM_DIER_UEDE
#define LPTIM_DMA_CC1                        LPTIM_DIER_CC1DE
#define LPTIM_DMA_CC2                        LPTIM_DIER_CC2DE
...
/** @defgroup LPTIM_DMA_Handle_index LPTIM DMA Handle Index
  * @{
  */
#define LPTIM_DMA_ID_UPDATE                ((uint16_t) 0x0000)
#define LPTIM_DMA_ID_CC1                   ((uint16_t) 0x0001)
#define LPTIM_DMA_ID_CC2                   ((uint16_t) 0x0002)
/**
  * @}
  */
...
/** @defgroup LPTIM_Channel LPTIM Channel
  * @{
  */
#define LPTIM_CHANNEL_1                      LL_LPTIM_CHANNEL_CH1
#define LPTIM_CHANNEL_2                      LL_LPTIM_CHANNEL_CH2
/**
  * @}
  */
...
/** @defgroup LPTIM_Output_Compare_Polarity LPTIM Output Compare Polarity
  * @{
  */
#define LPTIM_OCPOLARITY_HIGH                    0x00000000U
#define LPTIM_OCPOLARITY_LOW                     0x00000001U
/**
  * @}
  */
...
/** @defgroup LPTIM_Input_Capture_Prescaler LPTIM Input Capture Prescaler
  * @{
  */
#define LPTIM_ICPSC_DIV1                          0x00000000UL
#define LPTIM_ICPSC_DIV2                          LPTIM_CCMR1_IC1PSC_0
#define LPTIM_ICPSC_DIV4                          LPTIM_CCMR1_IC1PSC_1
#define LPTIM_ICPSC_DIV8                         (LPTIM_CCMR1_IC1PSC_0|LPTIM_CCMR1_IC1PSC_1)
/**
  * @}
  */
...
/** @defgroup LPTIM_Input_Capture_Polarity LPTIM Input Capture Polarity
  * @{
  */
#define LPTIM_ICPOLARITY_RISING                    0x00000000UL
#define LPTIM_ICPOLARITY_FALLING                   LPTIM_CCMR1_CC1P_0
#define LPTIM_ICPOLARITY_RISING_FALLING           (LPTIM_CCMR1_CC1P_0|LPTIM_CCMR1_CC1P_1)
/**
  * @}
  */
...
/** @defgroup LPTIM_Input_Capture_Filter LPTIM Input Capture Filter
  * @{
  */
#define LPTIM_ICFLT_CLOCK_DIV1                     0x00000000UL
#define LPTIM_ICFLT_CLOCK_DIV2                     LPTIM_CCMR1_IC1F_0
#define LPTIM_ICFLT_CLOCK_DIV4                     LPTIM_CCMR1_IC1F_1
#define LPTIM_ICFLT_CLOCK_DIV8                    (LPTIM_CCMR1_IC1F_0|LPTIM_CCMR1_IC1F_1)
/**
  * @}
  */
...
/** @defgroup LPTIM_Input_Capture_Source LPTIM Input Capture Source
  * @{
  */
#define LPTIM_IC1SOURCE_GPIO                       0x00000000UL
#define LPTIM_IC1SOURCE_COMP1                      LPTIM_CFGR2_IC1SEL_0
#if defined(COMP2)
#define LPTIM_IC1SOURCE_COMP2                      LPTIM_CFGR2_IC1SEL_1
#endif /* COMP2 */
#define LPTIM_IC2SOURCE_GPIO                       0x00000000UL
#define LPTIM_IC2SOURCE_LSI                        LPTIM_CFGR2_IC2SEL_0
#define LPTIM_IC2SOURCE_LSE                        LPTIM_CFGR2_IC2SEL_1
#define LPTIM_IC2SOURCE_HSI_256                    LPTIM_CFGR2_IC2SEL_0
#define LPTIM_IC2SOURCE_MSIS_1024                  LPTIM_CFGR2_IC2SEL_1
#define LPTIM_IC2SOURCE_MSIS_4                    (LPTIM_CFGR2_IC2SEL_0|LPTIM_CFGR2_IC2SEL_1)
/**
  * @}
  */
/**
