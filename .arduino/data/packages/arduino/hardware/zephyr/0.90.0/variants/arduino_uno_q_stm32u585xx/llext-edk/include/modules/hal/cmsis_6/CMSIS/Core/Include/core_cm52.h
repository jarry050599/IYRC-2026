...
#define SCB_DCISW_UC_WAY_Pos               31U
#define SCB_DCISW_UC_WAY_Msk               (1UL << SCB_DCISW_UC_WAY_Pos)

#define SCB_DCISW_UC_SET_Pos               5U
#define SCB_DCISW_UC_SET_Msk               (0x3FFUL << SCB_DCISW_UC_SET_Pos)

/** \brief SCB U-Cache Clean by Set-way Register Definitions */
#define SCB_DCCSW_UC_WAY_Pos               31U
#define SCB_DCCSW_UC_WAY_Msk               (1UL << SCB_DCCSW_UC_WAY_Pos)

#define SCB_DCCSW_UC_SET_Pos               5U
#define SCB_DCCSW_UC_SET_Msk               (0x3FFUL << SCB_DCCSW_UC_SET_Pos)

/** \brief SCB U-Cache Clean and Invalidate by Set-way Register Definitions */
#define SCB_DCCISW_UC_WAY_Pos              31U
#define SCB_DCCISW_UC_WAY_Msk              (1UL << SCB_DCCISW_UC_WAY_Pos)

#define SCB_DCCISW_UC_SET_Pos              5U
#define SCB_DCCISW_UC_SET_Msk              (0x3FFUL << SCB_DCCISW_UC_SET_Pos)
...
#define MEMSYSCTL_MSCR_CPWRDN_Msk          (1UL << MEMSYSCTL_MSCR_CPWRDN_Pos)

#define MEMSYSCTL_MSCR_DCCLEAN_Pos         16U
#define MEMSYSCTL_MSCR_DCCLEAN_Msk         (1UL << MEMSYSCTL_MSCR_DCCLEAN_Pos)

#define MEMSYSCTL_MSCR_ICACTIVE_Pos        13U
#define MEMSYSCTL_MSCR_ICACTIVE_Msk        (1UL << MEMSYSCTL_MSCR_ICACTIVE_Pos)
...
#define MEMSYSCTL_MSCR_TECCCHKDIS_Msk      (1UL << MEMSYSCTL_MSCR_TECCCHKDIS_Pos)

#define MEMSYSCTL_MSCR_EVECCFAULT_Pos       3U
#define MEMSYSCTL_MSCR_EVECCFAULT_Msk      (1UL << MEMSYSCTL_MSCR_EVECCFAULT_Pos)

#define MEMSYSCTL_MSCR_FORCEWT_Pos          2U
#define MEMSYSCTL_MSCR_FORCEWT_Msk         (1UL << MEMSYSCTL_MSCR_FORCEWT_Pos)

#define MEMSYSCTL_MSCR_ECCEN_Pos            1U
#define MEMSYSCTL_MSCR_ECCEN_Msk           (1UL << MEMSYSCTL_MSCR_ECCEN_Pos)
...
#define MEMSYSCTL_ITCMCR_EN_Msk            (1UL)
...
#define MEMSYSCTL_DTCMCR_EN_Msk            (1UL)
...
#define MEMSYSCTL_DTGU_CTRL_DEREN_Msk      (1UL << MEMSYSCTL_DTGU_CTRL_DEREN_Pos)

#define MEMSYSCTL_DTGU_CTRL_DBFEN_Pos       0U
#define MEMSYSCTL_DTGU_CTRL_DBFEN_Msk      (1UL)

/** \brief MemSysCtl DTGU Configuration Register Definitions */
#define MEMSYSCTL_DTGU_CFG_PRESENT_Pos     31U
#define MEMSYSCTL_DTGU_CFG_PRESENT_Msk     (1UL << MEMSYSCTL_DTGU_CFG_PRESENT_Pos)
...
typedef struct
{
  __IM  uint32_t DCADCRR;
  __IM  uint32_t DCAICRR;
        uint32_t RESERVED1[2];          
  __IOM uint32_t DCADCLR;
  __IOM uint32_t DCAICLR;
} DCAR_Type;
...
#define EWIC_EWIC_PSR_NZA_Msk              (1UL)
...
#define EWIC_ISA_EVENTSPR_NMI_Msk          (1UL << EWIC_ISA_EVENTSPR_NMI_Pos)

#define EWIC_ISA_EVENTSPR_EVENT_Pos         0U
#define EWIC_ISA_EVENTSPR_EVENT_Msk        (1UL)

/** \brief EWIC_ISA Event Mask A Register Definitions */
#define EWIC_ISA_EVENTMASKA_EDBGREQ_Pos     2U
#define EWIC_ISA_EVENTMASKA_EDBGREQ_Msk    (1UL << EWIC_ISA_EVENTMASKA_EDBGREQ_Pos)

#define EWIC_ISA_EVENTMASKA_NMI_Pos         1U
#define EWIC_ISA_EVENTMASKA_NMI_Msk        (1UL << EWIC_ISA_EVENTMASKA_NMI_Pos)

#define EWIC_ISA_EVENTMASKA_EVENT_Pos       0U
#define EWIC_ISA_EVENTMASKA_EVENT_Msk      (1UL)

/** \brief EWIC_ISA Event Mask n Register Definitions */
#define EWIC_ISA_EVENTMASKn_IRQ_Pos         0U
#define EWIC_ISA_EVENTMASKn_IRQ_Msk        (0xFFFFFFFFUL)
...
typedef struct
{
  ...
  __IM  uint32_t TEBRDATA0;        
  __IOM uint32_t TEBR1;
  __IM  uint32_t TEBRDATA1;
} ErrBnk_Type;
...
#define ERRBNK_IEBR0_BANK_Msk              (1UL << ERRBNK_IEBR0_BANK_Pos)
...
#define ERRBNK_IEBR0_LOCKED_Msk            (1UL << ERRBNK_IEBR0_LOCKED_Pos)

#define ERRBNK_IEBR0_VALID_Pos              0U
#define ERRBNK_IEBR0_VALID_Msk             (1UL <<)
...
#define ERRBNK_IEBR1_BANK_Msk              (1UL << ERRBNK_IEBR1_BANK_Pos)
...
#define ERRBNK_IEBR1_LOCKED_Msk            (1UL << ERRBNK_IEBR1_LOCKED_Pos)

#define ERRBNK_IEBR1_VALID_Pos              0U
#define ERRBNK_IEBR1_VALID_Msk             (1UL <<)
...
#define ERRBNK_DEBR0_TYPE_Msk              (1UL << ERRBNK_DEBR0_TYPE_Pos)

#define ERRBNK_DEBR0_BANK_Pos              16U
#define ERRBNK_DEBR0_BANK_Msk              (1UL << ERRBNK_DEBR0_BANK_Pos)
...
#define ERRBNK_DEBR0_LOCKED_Msk            (1UL << ERRBNK_DEBR0_LOCKED_Pos)

#define ERRBNK_DEBR0_VALID_Pos              0U
#define ERRBNK_DEBR0_VALID_Msk             (1UL <<)
...
#define ERRBNK_DEBR1_TYPE_Msk              (1UL << ERRBNK_DEBR1_TYPE_Pos)

#define ERRBNK_DEBR1_BANK_Pos              16U
#define ERRBNK_DEBR1_BANK_Msk              (1UL << ERRBNK_DEBR1_BANK_Pos)
...
#define ERRBNK_DEBR1_LOCKED_Msk            (1UL << ERRBNK_DEBR1_LOCKED_Pos)

#define ERRBNK_DEBR1_VALID_Pos              0U
#define ERRBNK_DEBR1_VALID_Msk             (1UL <<)
...
#define ERRBNK_TEBR0_POISON_Pos            27U
#define ERRBNK_TEBR0_POISON_Msk            (1UL << ERRBNK_TEBR0_POISON_Pos)

#define ERRBNK_TEBR0_TYPE_Pos              26U
#define ERRBNK_TEBR0_TYPE_Msk              (1UL << ERRBNK_TEBR0_TYPE_Pos)
...
#define ERRBNK_TEBR0_LOCKED_Msk            (1UL << ERRBNK_TEBR0_LOCKED_Pos)

#define ERRBNK_TEBR0_VALID_Pos              0U
#define ERRBNK_TEBR0_VALID_Msk             (1UL <<)
...
#define ERRBNK_TEBR1_POISON_Pos            27U
#define ERRBNK_TEBR1_POISON_Msk            (1UL << ERRBNK_TEBR1_POISON_Pos)

#define ERRBNK_TEBR1_TYPE_Pos              26U
#define ERRBNK_TEBR1_TYPE_Msk              (1UL << ERRBNK_TEBR1_TYPE_Pos)
...
#define ERRBNK_TEBR1_LOCKED_Msk            (1UL << ERRBNK_TEBR1_LOCKED_Pos)

#define ERRBNK_TEBR1_VALID_Pos              0U
#define ERRBNK_TEBR1_VALID_Msk             (1UL <<)
...
typedef struct
{
  ...
  __IM  uint32_t STLNVICACTVOR;
        uint32_t RESERVED0[2U];
  __IOM uint32_t STLIDMPUSR;
  __IM  uint32_t STLIMPUOR;
  __IM  uint32_t STLDMPUOR;
 
} STL_Type;

/** \brief STL NVIC Pending Priority Tree Register Definitions */
#define STL_STLNVICPENDOR_VALID_Pos        18U
#define STL_STLNVICPENDOR_VALID_Msk        (1UL << STL_STLNVICPENDOR_VALID_Pos)

#define STL_STLNVICPENDOR_TARGET_Pos       17U
#define STL_STLNVICPENDOR_TARGET_Msk       (1UL << STL_STLNVICPENDOR_TARGET_Pos)
...
#define STL_STLNVICACTVOR_VALID_Msk        (1UL << STL_STLNVICACTVOR_VALID_Pos)

#define STL_STLNVICACTVOR_TARGET_Pos       17U
#define STL_STLNVICACTVOR_TARGET_Msk       (1UL << STL_STLNVICACTVOR_TARGET_Pos)
...
#define STL_STLIDMPUSR_INSTR_Msk           (1UL << STL_STLIDMPUSR_INSTR_Pos)

#define STL_STLIDMPUSR_DATA_Pos             1U
#define STL_STLIDMPUSR_DATA_Msk            (1UL << STL_STLIDMPUSR_DATA_Pos)
...
#define STL_STLDMPUOR_HITREGION_Pos        9U
#define STL_STLDMPUOR_HITREGION_Msk       (0xFFUL << STL_STLDMPUOR_HITREGION_Pos)
 
#define STL_STLDMPUOR_ATTR_Pos             0U
#define STL_STLDMPUOR_ATTR_Msk            (0x1FFUL)
...
#define TPIU_CLAIMSET_SET_Pos               0U
#define TPIU_CLAIMSET_SET_Msk              (0xFUL)

/** \brief TPIU Claim Tag Clear Register Definitions */
#define TPIU_CLAIMCLR_CLR_Pos               0U
#define TPIU_CLAIMCLR_CLR_Msk              (0xFUL)
...
#define DCB_DHCSR_S_FPD_Msk                (1UL << DCB_DHCSR_S_FPD_Pos)

#define DCB_DHCSR_S_SUIDE_Pos              22U
#define DCB_DHCSR_S_SUIDE_Msk              (1UL << DCB_DHCSR_S_SUIDE_Pos)

#define DCB_DHCSR_S_NSUIDE_Pos             21U
#define DCB_DHCSR_S_NSUIDE_Msk             (1UL << DCB_DHCSR_S_NSUIDE_Pos)
...
#define DCB_DHCSR_C_PMOV_Msk               (1UL << DCB_DHCSR_C_PMOV_Pos)
...
#define DCB_DSCEMCR_CLR_MON_REQ_Msk        (1UL << DCB_DSCEMCR_CLR_MON_REQ_Pos)

#define DCB_DSCEMCR_CLR_MON_PEND_Pos       17U
#define DCB_DSCEMCR_CLR_MON_PEND_Msk       (1UL << DCB_DSCEMCR_CLR_MON_PEND_Pos)

#define DCB_DSCEMCR_SET_MON_REQ_Pos         3U
#define DCB_DSCEMCR_SET_MON_REQ_Msk        (1UL << DCB_DSCEMCR_SET_MON_REQ_Pos)

#define DCB_DSCEMCR_SET_MON_PEND_Pos        1U
#define DCB_DSCEMCR_SET_MON_PEND_Msk       (1UL << DCB_DSCEMCR_SET_MON_PEND_Pos)

/** \brief DCB Debug Authentication Control Register Definitions */
#define DCB_DAUTHCTRL_UIDEN_Pos            10U
#define DCB_DAUTHCTRL_UIDEN_Msk            (1UL << DCB_DAUTHCTRL_UIDEN_Pos)

#define DCB_DAUTHCTRL_UIDAPEN_Pos           9U
#define DCB_DAUTHCTRL_UIDAPEN_Msk          (1UL << DCB_DAUTHCTRL_UIDAPEN_Pos)

#define DCB_DAUTHCTRL_FSDMA_Pos             8U
#define DCB_DAUTHCTRL_FSDMA_Msk            (1UL << DCB_DAUTHCTRL_FSDMA_Pos)
...
/* Memory mapping of Core Hardware */
  ...
  #define DCAR                ((DCAR_Type      *)     DCAR_BASE        )
...
#define ARMCM52_PMU_ECC_ERR                          0xC000
#define ARMCM52_PMU_ECC_ERR_MBIT                     0xC001
#define ARMCM52_PMU_ECC_ERR_DCACHE                   0xC010
#define ARMCM52_PMU_ECC_ERR_ICACHE                   0xC011
#define ARMCM52_PMU_ECC_ERR_MBIT_DCACHE              0xC012
#define ARMCM52_PMU_ECC_ERR_MBIT_ICACHE              0xC013
#define ARMCM52_PMU_ECC_ERR_DTCM                     0xC020
#define ARMCM52_PMU_ECC_ERR_ITCM                     0xC021
#define ARMCM52_PMU_ECC_ERR_MBIT_DTCM                0xC022
#define ARMCM52_PMU_ECC_ERR_MBIT_ITCM                0xC023
#define ARMCM52_PMU_NWAMODE_ENTER                    0xC200
#define ARMCM52_PMU_NWAMODE                          0xC201
#define ARMCM52_PMU_SAHB_ACCESS                      0xC300
#define ARMCM52_PMU_PAHB_ACCESS                      0xC301
#define ARMCM52_PMU_AXI_SAHB_WRITE_ACCESS            0xC302
#define ARMCM52_PMU_AXI_SAHB_READ_ACCESS             0xC303
#define ARMCM52_PMU_DOSTIMEOUT_DOUBLE                0xC400
#define ARMCM52_PMU_DOSTIMEOUT_TRIPLE                0xC401
#define ARMCM52_PMU_CDE_INST_RETIRED                 0xC402
#define ARMCM52_PMU_CDE_CX1_INST_RETIRED             0xC404
#define ARMCM52_PMU_CDE_CX2_INST_RETIRED             0xC406
#define ARMCM52_PMU_CDE_CX3_INST_RETIRED             0xC408
#define ARMCM52_PMU_CDE_VCX1_INST_RETIRED            0xC40A
#define ARMCM52_PMU_CDE_VCX2_INST_RETIRED            0xC40C
#define ARMCM52_PMU_CDE_VCX3_INST_RETIRED            0xC40E
#define ARMCM52_PMU_CDE_VCX1_VEC_INST_RETIRED        0xC410
#define ARMCM52_PMU_CDE_VCX2_VEC_INST_RETIRED        0xC412
#define ARMCM52_PMU_CDE_VCX3_VEC_INST_RETIRED        0xC414
#define ARMCM52_PMU_CDE_PRED                         0xC416
#define ARMCM52_PMU_CDE_STALL                        0xC417
#define ARMCM52_PMU_CDE_STALL_RESOURCE               0xC418
#define ARMCM52_PMU_CDE_STALL_DEPENDENCY             0xC419
#define ARMCM52_PMU_CDE_STALL_CUSTOM                 0xC41A
#define ARMCM52_PMU_CDE_STALL_OTHER                  0xC41B
#define ARMCM52_PMU_CAHB_WRITE_ACCESS                0xC420
#define ARMCM52_PMU_CAHB_READ_ACCESS                 0xC421
