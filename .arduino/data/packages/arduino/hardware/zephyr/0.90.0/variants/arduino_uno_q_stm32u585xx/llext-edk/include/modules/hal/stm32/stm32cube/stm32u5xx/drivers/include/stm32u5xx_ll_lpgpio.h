...
/** @defgroup LPGPIO_LL_EC_PIN PIN
  * @{
  */
#define LL_LPGPIO_PIN_0                   LPGPIO_BSRR_BS0
#define LL_LPGPIO_PIN_1                   LPGPIO_BSRR_BS1
#define LL_LPGPIO_PIN_2                   LPGPIO_BSRR_BS2
#define LL_LPGPIO_PIN_3                   LPGPIO_BSRR_BS3
#define LL_LPGPIO_PIN_4                   LPGPIO_BSRR_BS4
#define LL_LPGPIO_PIN_5                   LPGPIO_BSRR_BS5
#define LL_LPGPIO_PIN_6                   LPGPIO_BSRR_BS6
#define LL_LPGPIO_PIN_7                   LPGPIO_BSRR_BS7
#define LL_LPGPIO_PIN_8                   LPGPIO_BSRR_BS8
#define LL_LPGPIO_PIN_9                   LPGPIO_BSRR_BS9
#define LL_LPGPIO_PIN_10                  LPGPIO_BSRR_BS10
#define LL_LPGPIO_PIN_11                  LPGPIO_BSRR_BS11
#define LL_LPGPIO_PIN_12                  LPGPIO_BSRR_BS12
#define LL_LPGPIO_PIN_13                  LPGPIO_BSRR_BS13
#define LL_LPGPIO_PIN_14                  LPGPIO_BSRR_BS14
#define LL_LPGPIO_PIN_15                  LPGPIO_BSRR_BS15
...
/** @defgroup LPGPIO_LL_EC_MODE Mode
  * @{
  */
#define LL_LPGPIO_MODE_INPUT                 (0x00000000U)
#define LL_LPGPIO_MODE_OUTPUT                LPGPIO_MODER_MOD0
/**
  * @}
  */
