...
#if (USE_HAL_IWDG_REGISTER_CALLBACKS == 1)
  void (* EwiCallback)(struct __IWDG_HandleTypeDef *hiwdg);
  void (* MspInitCallback)(struct __IWDG_HandleTypeDef *hiwdg);
#endif /* USE_HAL_IWDG_REGISTER_CALLBACKS */
} IWDG_HandleTypeDef;
...
typedef enum
{
  HAL_IWDG_EWI_CB_ID          = 0x00U,
  HAL_IWDG_MSPINIT_CB_ID      = 0x01U,
} HAL_IWDG_CallbackIDTypeDef;

/**
  * @brief  HAL IWDG Callback pointer definition
  */
typedef void (*pIWDG_CallbackTypeDef)(IWDG_HandleTypeDef *hppp);
#endif /* USE_HAL_IWDG_REGISTER_CALLBACKS */
...
#define IWDG_PRESCALER_512              (IWDG_PR_PR_2 | IWDG_PR_PR_1 | IWDG_PR_PR_0)
#define IWDG_PRESCALER_1024             IWDG_PR_PR_3
/**
  * @}
  */
...
/** @defgroup IWDG_EWI_Mode IWDG Early Wakeup Interrupt Mode
  * @{
  */
#define IWDG_EWI_DISABLE                0x00000000u
/**
  * @}
  */
