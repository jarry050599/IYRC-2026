...
typedef enum
{
  HAL_RAMCFG_MSPINIT_CB_ID           = 0x00U,
  HAL_RAMCFG_MSPDEINIT_CB_ID         = 0x01U,
  HAL_RAMCFG_SE_DETECT_CB_ID         = 0x02U,
  HAL_RAMCFG_DE_DETECT_CB_ID         = 0x03U,
  HAL_RAMCFG_ALL_CB_ID               = 0x04U,
...
#endif /* (USE_HAL_RAMCFG_REGISTER_CALLBACKS) */
{
  ...
  __IO HAL_RAMCFG_StateTypeDef    State;
  __IO uint32_t                   ErrorCode;
#if (USE_HAL_RAMCFG_REGISTER_CALLBACKS == 1)
  void (* MspInitCallback)(struct __RAMCFG_HandleTypeDef *hramcfg);
  void (* MspDeInitCallback)(struct __RAMCFG_HandleTypeDef *hramcfg);
  void (* DetectSingleErrorCallback)(struct __RAMCFG_HandleTypeDef *hramcfg);
  void (* DetectDoubleErrorCallback)(struct __RAMCFG_HandleTypeDef *hramcfg);
#endif  /* USE_HAL_RAMCFG_REGISTER_CALLBACKS */
...
/** @defgroup RAMCFG_Error_Codes RAMCFG Error Codes
  ...
  * @{
  */
#define HAL_RAMCFG_ERROR_NONE             0x00000000U
#define HAL_RAMCFG_ERROR_TIMEOUT          0x00000001U
#define HAL_RAMCFG_ERROR_BUSY             0x00000002U
#if (USE_HAL_RAMCFG_REGISTER_CALLBACKS == 1)
#define HAL_RAMCFG_ERROR_INVALID_CALLBACK 0x00000003U
#endif  /* USE_HAL_RAMCFG_REGISTER_CALLBACKS */
/**
  * @}
  */
...
/** @defgroup RAMCFG_Interrupt RAMCFG Interrupts
  ...
  * @{
  */
#define RAMCFG_IT_SINGLEERR   RAMCFG_IER_SEIE
#define RAMCFG_IT_DOUBLEERR   RAMCFG_IER_DEIE
#define RAMCFG_IT_NMIERR      RAMCFG_IER_ECCNMI
...
/** @defgroup RAMCFG_FLAG RAMCFG Monitor Flags
  ...
  * @{
  */
#define RAMCFG_FLAG_SINGLEERR   RAMCFG_ISR_SEDC
#define RAMCFG_FLAG_DOUBLEERR   RAMCFG_ISR_DED
#define RAMCFG_FLAG_SRAMBUSY    RAMCFG_ISR_SRAMBUSY
#define RAMCFG_FLAGS_ALL \
  (RAMCFG_ISR_SEDC | RAMCFG_ISR_DED  | RAMCFG_ISR_SRAMBUSY)
/**
  * @}
  */
...
/** @defgroup RAMCFG_WaitState RAMCFG Wait State
  ...
  * @{
  */
#define RAMCFG_WAITSTATE_0   (0U)
#define RAMCFG_WAITSTATE_1   (RAMCFG_CR_WSC_0)
#define RAMCFG_WAITSTATE_2   (RAMCFG_CR_WSC_1)
#define RAMCFG_WAITSTATE_3   (RAMCFG_CR_WSC_0 | RAMCFG_CR_WSC_1)
#define RAMCFG_WAITSTATE_4   (RAMCFG_CR_WSC_2)
#define RAMCFG_WAITSTATE_5   (RAMCFG_CR_WSC_0 | RAMCFG_CR_WSC_2)
#define RAMCFG_WAITSTATE_6   (RAMCFG_CR_WSC_1 | RAMCFG_CR_WSC_2)
#define RAMCFG_WAITSTATE_7   (RAMCFG_CR_WSC_0 | RAMCFG_CR_WSC_1 | RAMCFG_CR_WSC_2)
/**
  * @}
  */
...
#define RAMCFG_ERASE_KEY2  (0x53U)

#define RAMCFG_ECC_KEY1    (0xAEU)
#define RAMCFG_ECC_KEY2    (0x75U)
/**
  * @}
  */
