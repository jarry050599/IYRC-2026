...
#define LL_ICACHE_2WAYS                ICACHE_CR_WAYSEL
/**
  * @}
  */
...
/** @defgroup ICACHE_LL_EC_Monitor_Type Monitor type
  * @{
  */
#define LL_ICACHE_MONITOR_HIT          ICACHE_CR_HITMEN
#define LL_ICACHE_MONITOR_MISS         ICACHE_CR_MISSMEN
#define LL_ICACHE_MONITOR_ALL          (ICACHE_CR_HITMEN | ICACHE_CR_MISSMEN)
/**
  * @}
  */
...
/** @defgroup ICACHE_LL_EC_GET_FLAG Get Flags Defines
  ...
  * @{
  */
#define LL_ICACHE_SR_BUSYF             ICACHE_SR_BUSYF
#define LL_ICACHE_SR_BSYENDF           ICACHE_SR_BSYENDF
#define LL_ICACHE_SR_ERRF              ICACHE_SR_ERRF
/**
  * @}
  */
...
/** @defgroup ICACHE_LL_EC_CLEAR_FLAG Clear Flags Defines
  ...
  * @{
  */
#define LL_ICACHE_FCR_CBSYENDF         ICACHE_FCR_CBSYENDF
#define LL_ICACHE_FCR_CERRF            ICACHE_FCR_CERRF
/**
  * @}
  */
...
/** @defgroup ICACHE_LL_EC_IT IT Defines
  ...
  * @{
  */
#define LL_ICACHE_IER_BSYENDIE         ICACHE_IER_BSYENDIE
#define LL_ICACHE_IER_ERRIE            ICACHE_IER_ERRIE
/**
  * @}
  */
...
/** @defgroup ICACHE_LL_EC_Region Remapped Region number
  * @{
  */
#define LL_ICACHE_REGION_0             0U
#define LL_ICACHE_REGION_1             1U
#define LL_ICACHE_REGION_2             2U
#define LL_ICACHE_REGION_3             3U
/**
  * @}
  */
...
/** @defgroup ICACHE_LL_EC_Region_Size Remapped Region size
  * @{
  */
#define LL_ICACHE_REGIONSIZE_2MB       1U
#define LL_ICACHE_REGIONSIZE_4MB       2U
#define LL_ICACHE_REGIONSIZE_8MB       3U
#define LL_ICACHE_REGIONSIZE_16MB      4U
#define LL_ICACHE_REGIONSIZE_32MB      5U
#define LL_ICACHE_REGIONSIZE_64MB      6U
#define LL_ICACHE_REGIONSIZE_128MB     7U
/**
  * @}
  */
...
/** @defgroup ICACHE_LL_EC_Traffic_Route Remapped Traffic route
  * @{
  */
#define LL_ICACHE_MASTER1_PORT         0U
#define LL_ICACHE_MASTER2_PORT         ICACHE_CRRx_MSTSEL
/**
  * @}
  */
...
/** @defgroup ICACHE_LL_EC_Output_Burst_Type Remapped Output burst type
  * @{
  */
#define LL_ICACHE_OUTPUT_BURST_WRAP    0U
#define LL_ICACHE_OUTPUT_BURST_INCR    ICACHE_CRRx_HBURST
/**
  * @}
  */
