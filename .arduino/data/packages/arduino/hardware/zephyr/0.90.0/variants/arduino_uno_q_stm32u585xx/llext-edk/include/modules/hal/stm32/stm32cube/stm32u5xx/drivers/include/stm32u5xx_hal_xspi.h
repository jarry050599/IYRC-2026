...
typedef enum
{
  HAL_XSPI_ERROR_CB_ID          = 0x00U,
  HAL_XSPI_ABORT_CB_ID          = 0x01U,
  HAL_XSPI_FIFO_THRESHOLD_CB_ID = 0x02U,
  HAL_XSPI_CMD_CPLT_CB_ID       = 0x03U,
  HAL_XSPI_RX_CPLT_CB_ID        = 0x04U,
  HAL_XSPI_TX_CPLT_CB_ID        = 0x05U,
  HAL_XSPI_RX_HALF_CPLT_CB_ID   = 0x06U,
  HAL_XSPI_TX_HALF_CPLT_CB_ID   = 0x07U,
  HAL_XSPI_STATUS_MATCH_CB_ID   = 0x08U,
  HAL_XSPI_TIMEOUT_CB_ID        = 0x09U,
  HAL_XSPI_MSP_INIT_CB_ID       = 0x0AU,
  HAL_XSPI_MSP_DEINIT_CB_ID     = 0x0BU
...
/** @defgroup XSPI_State XSPI State
  * @{
  */
#define HAL_XSPI_STATE_RESET                 (0x00000000U)
#define HAL_XSPI_STATE_READY                 (0x00000002U)
#define HAL_XSPI_STATE_HYPERBUS_INIT         (0x00000001U)
#define HAL_XSPI_STATE_CMD_CFG               (0x00000004U)
#define HAL_XSPI_STATE_READ_CMD_CFG          (0x00000014U)
#define HAL_XSPI_STATE_WRITE_CMD_CFG         (0x00000024U)
#define HAL_XSPI_STATE_BUSY_CMD              (0x00000008U)
#define HAL_XSPI_STATE_BUSY_TX               (0x00000018U)
#define HAL_XSPI_STATE_BUSY_RX               (0x00000028U)
#define HAL_XSPI_STATE_BUSY_AUTO_POLLING     (0x00000048U)
#define HAL_XSPI_STATE_BUSY_MEM_MAPPED       (0x00000088U)
#define HAL_XSPI_STATE_ABORT                 (0x00000100U)
#define HAL_XSPI_STATE_ERROR                 (0x00000200U)
/**
  * @}
  */
...
#define HAL_XSPI_ERROR_DMA                   (0x00000004U)
#define HAL_XSPI_ERROR_INVALID_PARAM         (0x00000008U)
#define HAL_XSPI_ERROR_INVALID_SEQUENCE      (0x00000010U)
#if defined(USE_HAL_XSPI_REGISTER_CALLBACKS) && (USE_HAL_XSPI_REGISTER_CALLBACKS == 1U)
#define HAL_XSPI_ERROR_INVALID_CALLBACK      (0x00000020U)
#endif /* (USE_HAL_XSPI_REGISTER_CALLBACKS) && (USE_HAL_XSPI_REGISTER_CALLBACKS == 1U) */
/**
  * @}
  */
...
/** @defgroup XSPI_MemoryMode XSPI Memory Mode
  * @{
  */
#define HAL_XSPI_SINGLE_MEM                  (0x00000000U)
#define HAL_XSPI_DUAL_MEM                    (XSPI_CR_DMM)
...
#define HAL_XSPI_MEMTYPE_MACRONIX            (XSPI_DCR1_MTYP_0)
#define HAL_XSPI_MEMTYPE_APMEM               (XSPI_DCR1_MTYP_1)
#define HAL_XSPI_MEMTYPE_MACRONIX_RAM        ((XSPI_DCR1_MTYP_1 | XSPI_DCR1_MTYP_0))
#define HAL_XSPI_MEMTYPE_HYPERBUS            (XSPI_DCR1_MTYP_2)
#define HAL_XSPI_MEMTYPE_APMEM_16BITS        ((XSPI_DCR1_MTYP_2 | XSPI_DCR1_MTYP_1))
...
/** @defgroup XSPI_MemorySize XSPI Memory Size
  * @{
  */
#define HAL_XSPI_SIZE_16B                    (0x00000000U)
#define HAL_XSPI_SIZE_32B                    (0x00000001U)
#define HAL_XSPI_SIZE_64B                    (0x00000002U)
#define HAL_XSPI_SIZE_128B                   (0x00000003U)
#define HAL_XSPI_SIZE_256B                   (0x00000004U)
#define HAL_XSPI_SIZE_512B                   (0x00000005U)
#define HAL_XSPI_SIZE_1KB                    (0x00000006U)
#define HAL_XSPI_SIZE_2KB                    (0x00000007U)
#define HAL_XSPI_SIZE_4KB                    (0x00000008U)
#define HAL_XSPI_SIZE_8KB                    (0x00000009U)
#define HAL_XSPI_SIZE_16KB                   (0x0000000AU)
#define HAL_XSPI_SIZE_32KB                   (0x0000000BU)
#define HAL_XSPI_SIZE_64KB                   (0x0000000CU)
#define HAL_XSPI_SIZE_128KB                  (0x0000000DU)
#define HAL_XSPI_SIZE_256KB                  (0x0000000EU)
#define HAL_XSPI_SIZE_512KB                  (0x0000000FU)
#define HAL_XSPI_SIZE_1MB                    (0x00000010U)
#define HAL_XSPI_SIZE_2MB                    (0x00000011U)
#define HAL_XSPI_SIZE_4MB                    (0x00000012U)
#define HAL_XSPI_SIZE_8MB                    (0x00000013U)
#define HAL_XSPI_SIZE_16MB                   (0x00000014U)
#define HAL_XSPI_SIZE_32MB                   (0x00000015U)
#define HAL_XSPI_SIZE_64MB                   (0x00000016U)
#define HAL_XSPI_SIZE_128MB                  (0x00000017U)
#define HAL_XSPI_SIZE_256MB                  (0x00000018U)
#define HAL_XSPI_SIZE_512MB                  (0x00000019U)
#define HAL_XSPI_SIZE_1GB                    (0x0000001AU)
#define HAL_XSPI_SIZE_2GB                    (0x0000001BU)
#define HAL_XSPI_SIZE_4GB                    (0x0000001CU)
#define HAL_XSPI_SIZE_8GB                    (0x0000001DU)
#define HAL_XSPI_SIZE_16GB                   (0x0000001EU)
#define HAL_XSPI_SIZE_32GB                   (0x0000001FU)
/**
  * @}
  */
...
/** @defgroup XSPI_FreeRunningClock XSPI Free Running Clock
  * @{
  */
#define HAL_XSPI_FREERUNCLK_DISABLE          (0x00000000U)
#define HAL_XSPI_FREERUNCLK_ENABLE           ((uint32_t)XSPI_DCR1_FRCK)
/**
  * @}
  */
...
/** @defgroup XSPI_ClockMode XSPI Clock Mode
  * @{
  */
#define HAL_XSPI_CLOCK_MODE_0                (0x00000000U)
#define HAL_XSPI_CLOCK_MODE_3                ((uint32_t)XSPI_DCR1_CKMODE)
/**
  * @}
  */
...
/** @defgroup XSPI_WrapSize XSPI Wrap-Size
  * @{
  */
#define HAL_XSPI_WRAP_NOT_SUPPORTED          (0x00000000U)
#define HAL_XSPI_WRAP_16_BYTES               ((uint32_t)XSPI_DCR2_WRAPSIZE_1)
#define HAL_XSPI_WRAP_32_BYTES               ((uint32_t)(XSPI_DCR2_WRAPSIZE_0 | XSPI_DCR2_WRAPSIZE_1))
#define HAL_XSPI_WRAP_64_BYTES               ((uint32_t)XSPI_DCR2_WRAPSIZE_2)
#define HAL_XSPI_WRAP_128_BYTES              ((uint32_t)(XSPI_DCR2_WRAPSIZE_0 | XSPI_DCR2_WRAPSIZE_2))
/**
  * @}
  */
...
/** @defgroup XSPI_SampleShifting XSPI Sample Shifting
  * @{
  */
#define HAL_XSPI_SAMPLE_SHIFT_NONE           (0x00000000U)
#define HAL_XSPI_SAMPLE_SHIFT_HALFCYCLE      ((uint32_t)XSPI_TCR_SSHIFT)
/**
  * @}
  */
...
/** @defgroup XSPI_DelayHoldQuarterCycle XSPI Delay Hold Quarter Cycle
  * @{
  */
#define HAL_XSPI_DHQC_DISABLE                (0x00000000U)
#define HAL_XSPI_DHQC_ENABLE                 ((uint32_t)XSPI_TCR_DHQC)
/**
  * @}
  */
...
/** @defgroup XSPI_ChipSelectBoundary XSPI Chip Select Boundary
  * @{
  */
#define HAL_XSPI_BONDARYOF_NONE              (0x00000000U)
#define HAL_XSPI_BONDARYOF_16B               (0x00000001U)
#define HAL_XSPI_BONDARYOF_32B               (0x00000002U)
#define HAL_XSPI_BONDARYOF_64B               (0x00000003U)
#define HAL_XSPI_BONDARYOF_128B              (0x00000004U)
#define HAL_XSPI_BONDARYOF_256B              (0x00000005U)
#define HAL_XSPI_BONDARYOF_512B              (0x00000006U)
#define HAL_XSPI_BONDARYOF_1KB               (0x00000007U)
#define HAL_XSPI_BONDARYOF_2KB               (0x00000008U)
#define HAL_XSPI_BONDARYOF_4KB               (0x00000009U)
#define HAL_XSPI_BONDARYOF_8KB               (0x0000000AU)
#define HAL_XSPI_BONDARYOF_16KB              (0x0000000BU)
#define HAL_XSPI_BONDARYOF_32KB              (0x0000000CU)
#define HAL_XSPI_BONDARYOF_64KB              (0x0000000DU)
#define HAL_XSPI_BONDARYOF_128KB             (0x0000000EU)
#define HAL_XSPI_BONDARYOF_256KB             (0x0000000FU)
#define HAL_XSPI_BONDARYOF_512KB             (0x00000010U)
#define HAL_XSPI_BONDARYOF_1MB               (0x00000011U)
#define HAL_XSPI_BONDARYOF_2MB               (0x00000012U)
#define HAL_XSPI_BONDARYOF_4MB               (0x00000013U)
#define HAL_XSPI_BONDARYOF_8MB               (0x00000014U)
#define HAL_XSPI_BONDARYOF_16MB              (0x00000015U)
#define HAL_XSPI_BONDARYOF_32MB              (0x00000016U)
#define HAL_XSPI_BONDARYOF_64MB              (0x00000017U)
#define HAL_XSPI_BONDARYOF_128MB             (0x00000018U)
#define HAL_XSPI_BONDARYOF_256MB             (0x00000019U)
#define HAL_XSPI_BONDARYOF_512MB             (0x0000001AU)
#define HAL_XSPI_BONDARYOF_1GB               (0x0000001BU)
#define HAL_XSPI_BONDARYOF_2GB               (0x0000001CU)
#define HAL_XSPI_BONDARYOF_4GB               (0x0000001DU)
#define HAL_XSPI_BONDARYOF_8GB               (0x0000001EU)
#define HAL_XSPI_BONDARYOF_16GB              (0x0000001FU)
/**
  * @}
  */
...
/** @defgroup XSPI_DelayBlockBypass XSPI Delay Block Bypaas
  * @{
  */
#define HAL_XSPI_DELAY_BLOCK_ON              (0x00000000U)
#define HAL_XSPI_DELAY_BLOCK_BYPASS          ((uint32_t)OCTOSPI_DCR1_DLYBYP)
/**
  * @}
  */
...
#define HAL_XSPI_OPTYPE_WRAP_CFG             (0x00000003U)
...
/** @defgroup XSPI_IOSelect XSPI IO Select
  * @{
  */
#define HAL_XSPI_SELECT_IO_3_0               (0x00000000U)
#if defined(HSPI_CR_MSEL)
#define HAL_XSPI_SELECT_IO_7_4               ((uint32_t)HSPI_CR_MSEL_0 | OCTOSPI_CR_MSEL)
#define HAL_XSPI_SELECT_IO_11_8              ((uint32_t)HSPI_CR_MSEL_1)
#define HAL_XSPI_SELECT_IO_15_12             ((uint32_t)HSPI_CR_MSEL | OCTOSPI_CR_MSEL)
#define HAL_XSPI_SELECT_IO_7_0               (0x00000000U)
#define HAL_XSPI_SELECT_IO_15_8              ((uint32_t)HSPI_CR_MSEL_1)
#else
#define HAL_XSPI_SELECT_IO_7_4               ((uint32_t)OCTOSPI_CR_MSEL)
#define HAL_XSPI_SELECT_IO_7_0               (0x00000000U)
#endif /* HSPI_CR_MSEL */
/**
  * @}
...
#define HAL_XSPI_INSTRUCTION_1_LINE          ((uint32_t)XSPI_CCR_IMODE_0)
#define HAL_XSPI_INSTRUCTION_2_LINES         ((uint32_t)XSPI_CCR_IMODE_1)
#define HAL_XSPI_INSTRUCTION_4_LINES         ((uint32_t)(XSPI_CCR_IMODE_0 | XSPI_CCR_IMODE_1))
#define HAL_XSPI_INSTRUCTION_8_LINES         ((uint32_t)XSPI_CCR_IMODE_2)
/**
  * @}
  */
...
#define HAL_XSPI_INSTRUCTION_16_BITS         ((uint32_t)XSPI_CCR_ISIZE_0)
#define HAL_XSPI_INSTRUCTION_24_BITS         ((uint32_t)XSPI_CCR_ISIZE_1)
#define HAL_XSPI_INSTRUCTION_32_BITS         ((uint32_t)XSPI_CCR_ISIZE)
/**
  * @}
  */
...
#define HAL_XSPI_INSTRUCTION_DTR_ENABLE      ((uint32_t)XSPI_CCR_IDTR)
/**
  * @}
  */
...
#define HAL_XSPI_ADDRESS_1_LINE              ((uint32_t)XSPI_CCR_ADMODE_0)
#define HAL_XSPI_ADDRESS_2_LINES             ((uint32_t)XSPI_CCR_ADMODE_1)
#define HAL_XSPI_ADDRESS_4_LINES             ((uint32_t)(XSPI_CCR_ADMODE_0 | XSPI_CCR_ADMODE_1))
#define HAL_XSPI_ADDRESS_8_LINES             ((uint32_t)XSPI_CCR_ADMODE_2)
/**
  * @}
  */
...
/** @defgroup XSPI_AddressWidth XSPI Address width
  * @{
  */
#define HAL_XSPI_ADDRESS_8_BITS              (0x00000000U)
#define HAL_XSPI_ADDRESS_16_BITS             ((uint32_t)XSPI_CCR_ADSIZE_0)
#define HAL_XSPI_ADDRESS_24_BITS             ((uint32_t)XSPI_CCR_ADSIZE_1)
#define HAL_XSPI_ADDRESS_32_BITS             ((uint32_t)XSPI_CCR_ADSIZE)
/**
  * @}
  */
...
#define HAL_XSPI_ADDRESS_DTR_ENABLE          ((uint32_t)XSPI_CCR_ADDTR)
/**
  * @}
  */
...
#define HAL_XSPI_ALT_BYTES_1_LINE            ((uint32_t)XSPI_CCR_ABMODE_0)
#define HAL_XSPI_ALT_BYTES_2_LINES           ((uint32_t)XSPI_CCR_ABMODE_1)
#define HAL_XSPI_ALT_BYTES_4_LINES           ((uint32_t)(XSPI_CCR_ABMODE_0 | XSPI_CCR_ABMODE_1))
#define HAL_XSPI_ALT_BYTES_8_LINES           ((uint32_t)XSPI_CCR_ABMODE_2)
/**
  * @}
  */
...
#define HAL_XSPI_ALT_BYTES_16_BITS           ((uint32_t)XSPI_CCR_ABSIZE_0)
#define HAL_XSPI_ALT_BYTES_24_BITS           ((uint32_t)XSPI_CCR_ABSIZE_1)
#define HAL_XSPI_ALT_BYTES_32_BITS           ((uint32_t)XSPI_CCR_ABSIZE)
/**
  * @}
  */
...
#define HAL_XSPI_ALT_BYTES_DTR_ENABLE        ((uint32_t)XSPI_CCR_ABDTR)
/**
  * @}
  */
...
#define HAL_XSPI_DATA_1_LINE                 ((uint32_t)XSPI_CCR_DMODE_0)
#define HAL_XSPI_DATA_2_LINES                ((uint32_t)XSPI_CCR_DMODE_1)
#define HAL_XSPI_DATA_4_LINES                ((uint32_t)(XSPI_CCR_DMODE_0 | XSPI_CCR_DMODE_1))
#define HAL_XSPI_DATA_8_LINES                ((uint32_t)XSPI_CCR_DMODE_2)
#if defined(HSPI_CR_MSEL)
#define HAL_XSPI_DATA_16_LINES               ((uint32_t)(XSPI_CCR_DMODE_0 | XSPI_CCR_DMODE_2))
...
#define HAL_XSPI_DATA_DTR_ENABLE             ((uint32_t)XSPI_CCR_DDTR)
/**
  * @}
  */
...
#define HAL_XSPI_DQS_ENABLE                  ((uint32_t)XSPI_CCR_DQSE)
/**
  * @}
  */
...
/** @defgroup XSPI_SIOOMode XSPI SIOO Mode
  * @{
  */
#define HAL_XSPI_SIOO_INST_EVERY_CMD         (0x00000000U)
#define HAL_XSPI_SIOO_INST_ONLY_FIRST_CMD    ((uint32_t)XSPI_CCR_SIOO)
/**
  * @}
  */
...
/** @defgroup XSPI_WriteZeroLatency XSPI Hyperbus Write Zero Latency Activation
  * @{
  */
#define HAL_XSPI_LATENCY_ON_WRITE            (0x00000000U)
#define HAL_XSPI_NO_LATENCY_ON_WRITE         ((uint32_t)XSPI_HLCR_WZL)
/**
  * @}
  */
...
/** @defgroup XSPI_LatencyMode XSPI Hyperbus Latency Mode
  * @{
  */
#define HAL_XSPI_VARIABLE_LATENCY            (0x00000000U)
#define HAL_XSPI_FIXED_LATENCY               ((uint32_t)XSPI_HLCR_LM)
/**
  * @}
  */
...
/** @defgroup XSPI_AddressSpace XSPI Hyperbus Address Space
  * @{
  */
#define HAL_XSPI_MEMORY_ADDRESS_SPACE        (0x00000000U)
#define HAL_XSPI_REGISTER_ADDRESS_SPACE      ((uint32_t)XSPI_DCR1_MTYP_0)
/**
  * @}
  */
...
/** @defgroup XSPI_MatchMode XSPI Match Mode
  * @{
  */
#define HAL_XSPI_MATCH_MODE_AND              (0x00000000U)
#define HAL_XSPI_MATCH_MODE_OR               ((uint32_t)XSPI_CR_PMM)
/**
  * @}
  */
...
/** @defgroup XSPI_AutomaticStop XSPI Automatic Stop
  * @{
  */
#define HAL_XSPI_AUTOMATIC_STOP_DISABLE      (0x00000000U)
#define HAL_XSPI_AUTOMATIC_STOP_ENABLE       ((uint32_t)XSPI_CR_APMS)
/**
  * @}
  */
...
#define HAL_XSPI_TIMEOUT_COUNTER_ENABLE      ((uint32_t)XSPI_CR_TCEN)
/**
  * @}
  */
...
/** @defgroup XSPI_Flags XSPI Flags
  * @{
  */
#define HAL_XSPI_FLAG_BUSY                   XSPI_SR_BUSY
#define HAL_XSPI_FLAG_TO                     XSPI_SR_TOF
#define HAL_XSPI_FLAG_SM                     XSPI_SR_SMF
#define HAL_XSPI_FLAG_FT                     XSPI_SR_FTF
#define HAL_XSPI_FLAG_TC                     XSPI_SR_TCF
#define HAL_XSPI_FLAG_TE                     XSPI_SR_TEF
/**
  * @}
  */
...
/** @defgroup XSPI_Interrupts XSPI Interrupts
  * @{
  */
#define HAL_XSPI_IT_TO                       XSPI_CR_TOIE
#define HAL_XSPI_IT_SM                       XSPI_CR_SMIE
#define HAL_XSPI_IT_FT                       XSPI_CR_FTIE
#define HAL_XSPI_IT_TC                       XSPI_CR_TCIE
#define HAL_XSPI_IT_TE                       XSPI_CR_TEIE
/**
  * @}
  */
...
/** @defgroup XSPI_IO_Manger_IOPort XSPI IO Port
  * @{
  */
#define HAL_XSPIM_IOPORT_NONE              (0x00000000U)
#define HAL_XSPIM_IOPORT_1_LOW             ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x1U))
#define HAL_XSPIM_IOPORT_1_HIGH            ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x1U))
#define HAL_XSPIM_IOPORT_2_LOW             ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x2U))
#define HAL_XSPIM_IOPORT_2_HIGH            ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x2U))
#define HAL_XSPIM_IOPORT_3_LOW             ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x3U))
#define HAL_XSPIM_IOPORT_3_HIGH            ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x3U))
#define HAL_XSPIM_IOPORT_4_LOW             ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x4U))
#define HAL_XSPIM_IOPORT_4_HIGH            ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x4U))
#define HAL_XSPIM_IOPORT_5_LOW             ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x5U))
#define HAL_XSPIM_IOPORT_5_HIGH            ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x5U))
#define HAL_XSPIM_IOPORT_6_LOW             ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x6U))
#define HAL_XSPIM_IOPORT_6_HIGH            ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x6U))
#define HAL_XSPIM_IOPORT_7_LOW             ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x7U))
#define HAL_XSPIM_IOPORT_7_HIGH            ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x7U))
#define HAL_XSPIM_IOPORT_8_LOW             ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x8U))
#define HAL_XSPIM_IOPORT_8_HIGH            ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x8U))
/**
  * @}
  */
...
/** @defgroup XSPI_DelayType XSPI Calibration Delay Type
  * @{
  */
#define HAL_XSPI_CAL_FULL_CYCLE_DELAY      (0x00000000U)
#define HAL_XSPI_CAL_FEEDBACK_CLK_DELAY    (0x00000001U)
#define HAL_XSPI_CAL_DATA_OUTPUT_DELAY     (0x00000002U)
#define HAL_XSPI_CAL_DQS_INPUT_DELAY       (0x00000003U)
/**
  * @}
  */
...
/** @defgroup XSPI_MaxCal XSPI Calibration Maximal Value
  * @{
  */
#define HAL_XSPI_MAXCAL_NOT_REACHED        (0x00000000U)
#define HAL_XSPI_MAXCAL_REACHED            ((uint32_t)HSPI_CALFCR_CALMAX)
/**
  * @}
  */
