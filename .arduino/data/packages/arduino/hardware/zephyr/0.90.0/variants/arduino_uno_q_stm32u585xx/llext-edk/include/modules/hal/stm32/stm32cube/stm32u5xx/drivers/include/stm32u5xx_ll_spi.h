...
/** @defgroup SPI_LL_EC_AUTOCR_TRIGSEL  Autonomous Trigger selection
  ...
  * @{
  */
#define LL_SPI_TRIG_GRP1                   (0x10000000U)
#if defined(SPI3)
#define LL_SPI_TRIG_GRP2                   (0x20000000U)
#endif /* SPI3 */
...
/** @defgroup SPI_LL_EC_AUTOCR_TRIGPOL  Autonomous Trigger Polarity
  ...
  * @{
  */
#define LL_SPI_TRIG_POLARITY_RISING         0x00000000U
#define LL_SPI_TRIG_POLARITY_FALLING        SPI_AUTOCR_TRIGPOL
/**
  * @}
  */
