...
#define DWT_FUNCTION_ACTION_Msk            (1UL << DWT_FUNCTION_ACTION_Pos)
...
#define BPU_CTRL_REV_Pos               28U
#define BPU_CTRL_REV_Msk               (0xFUL << BPU_CTRL_REV_Pos)

#define BPU_CTRL_NUM_CODE_H_Pos        12U
#define BPU_CTRL_NUM_CODE_H_Msk        (0x7UL << BPU_CTRL_NUM_CODE_H_Pos)

#define BPU_CTRL_NUM_LIT_Pos           8U
#define BPU_CTRL_NUM_LIT_Msk           (0xFUL << BPU_CTRL_NUM_LIT_Pos)

#define BPU_CTRL_NUM_CODE_L_Pos        4U
#define BPU_CTRL_NUM_CODE_L_Msk        (0xFUL << BPU_CTRL_NUM_CODE_L_Pos)

#define BPU_CTRL_KEY_Pos               1U
#define BPU_CTRL_KEY_Msk               (0x1UL << BPU_CTRL_KEY_Pos)

#define BPU_CTRL_ENABLE_Pos            0U
#define BPU_CTRL_ENABLE_Msk            (0x1UL << BPU_CTRL_ENABLE_Pos)

/** \brief BPU Comparator Register Definitions */
#define BPU_COMP_BPADDR_Pos            1U
#define BPU_COMP_BPADDR_Msk            (0x7FFFFFFFUL << BPU_COMP_BPADDR_Pos)

#define BPU_COMP_BE_Pos                0U
#define BPU_COMP_BE_Msk                (0x1UL << BPU_COMP_BE_Pos)
