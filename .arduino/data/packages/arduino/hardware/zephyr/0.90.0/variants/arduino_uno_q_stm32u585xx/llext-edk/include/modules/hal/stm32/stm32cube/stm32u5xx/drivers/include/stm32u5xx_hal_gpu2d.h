...
typedef enum
{
  HAL_GPU2D_STATE_RESET             = 0x00U,
  HAL_GPU2D_STATE_READY             = 0x01U,
  HAL_GPU2D_STATE_BUSY              = 0x02U,
  HAL_GPU2D_STATE_TIMEOUT           = 0x03U,
...
{
  GPU2D_TypeDef                Instance;

  HAL_LockTypeDef              Lock;

  HAL_GPU2D_StateTypeDef       State;

  uint32_t                     ErrorCode;

#if (USE_HAL_GPU2D_REGISTER_CALLBACKS == 1)
  void (* CommandListCpltCallback)(struct __GPU2D_HandleTypeDef *hgpu2d, uint32_t CmdListID);

  void (* MspInitCallback)(struct __GPU2D_HandleTypeDef *hgpu2d);

  void (* MspDeInitCallback)(struct __GPU2D_HandleTypeDef *hgpu2d);
#endif /* USE_HAL_GPU2D_REGISTER_CALLBACKS = 1 */
} GPU2D_HandleTypeDef;
...
typedef enum
{
  HAL_GPU2D_MSPINIT_CB_ID             = 0x00U,
  HAL_GPU2D_MSPDEINIT_CB_ID           = 0x01U,
...
/** @defgroup HAL_GPU2D_Callback_pointer_definition HAL GPU2D Callback pointer definition
  ...
  * @{
  */
typedef  void (*pGPU2D_CallbackTypeDef)(GPU2D_HandleTypeDef *hgpu2d);
typedef  void (*pGPU2D_CommandListCpltCallbackTypeDef)(GPU2D_HandleTypeDef *hgpu2d, uint32_t CmdID);
#endif /* USE_HAL_GPU2D_REGISTER_CALLBACKS = 1 */
/**
  * @}
  */
...
/** @defgroup GPU2D_Error_Code_definition GPU2D Error Code definition
  ...
  * @{
  */
#define HAL_GPU2D_ERROR_NONE             (0x00000000U)
#define HAL_GPU2D_ERROR_TIMEOUT          (0x00000001U)
#if (USE_HAL_GPU2D_REGISTER_CALLBACKS == 1)
#define HAL_GPU2D_ERROR_INVALID_CALLBACK (0x00000002U)
#endif /* USE_HAL_GPU2D_REGISTER_CALLBACKS = 1 */
/**
  * @}
  */
...
/** @defgroup GPU2D_Interrupt_configuration_definition GPU2D Interrupt configuration definition
  ...
  * @{
  */
#define GPU2D_IT_CLC                     0x00000001U
/**
  * @}
  */
...
/** @defgroup GPU2D_Flag_definition GPU2D Flag definition
  ...
  * @{
  */
#define GPU2D_FLAG_CLC                   0x00000001U
/**
  * @}
  */
...
#define GPU2D_ITCTRL                    (0x0F8U)
#define GPU2D_CLID                      (0x148U)
#define GPU2D_BREAKPOINT                (0x080U)
#define GPU2D_SYS_INTERRUPT             (0xff8U)

/** @defgroup GPU2D_Offset GPU2D Last Register Offset
  * @{
  */
#define GPU2D_OFFSET                     0x1000U
/**
  * @}
  */
