...
#define SPI_NOR_FLSR_READY           BIT(7)
#define SPI_NOR_FLSR_ERASE_SUSPEND   BIT(6)
#define SPI_NOR_FLSR_ERASE_FAIL      BIT(5)
#define SPI_NOR_FLSR_PROGRAM_FAIL    BIT(4)
#define SPI_NOR_FLSR_PROGRAM_SUSPEND BIT(2)
#define SPI_NOR_FLSR_PROT_ERROR      BIT(1)
#define SPI_NOR_FLSR_4BA             BIT(0)
...
#define SPI_NOR_CMD_RDFLSR       0x70
#define SPI_NOR_CMD_CLRFLSR      0x50
#define SPI_NOR_CMD_WR_VCFGREG   0x81
#define SPI_NOR_OCMD_READ        0xFD
