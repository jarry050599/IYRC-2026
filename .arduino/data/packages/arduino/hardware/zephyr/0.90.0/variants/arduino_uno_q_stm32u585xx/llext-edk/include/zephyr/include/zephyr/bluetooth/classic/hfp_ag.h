...
enum hfp_ag_hf_indicators {
	HFP_AG_ENHANCED_SAFETY_IND = 1,
	HFP_AG_BATTERY_LEVEL_IND = 2,
};

/* The status of the call */
enum __packed bt_hfp_ag_call_status {
	BT_HFP_AG_CALL_STATUS_ACTIVE = 0,
	BT_HFP_AG_CALL_STATUS_HELD = 1,
	BT_HFP_AG_CALL_STATUS_DIALING = 2,
	BT_HFP_AG_CALL_STATUS_ALERTING = 3,
	BT_HFP_AG_CALL_STATUS_INCOMING = 4,
	BT_HFP_AG_CALL_STATUS_WAITING = 5,
	BT_HFP_AG_CALL_STATUS_INCOMING_HELD = 6
};

/* The direction of the call */
enum __packed bt_hfp_ag_call_dir {
	BT_HFP_AG_CALL_DIR_OUTGOING = 0,
	BT_HFP_AG_CALL_DIR_INCOMING = 1,
};
