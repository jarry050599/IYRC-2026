...
/** @defgroup PKA_LL_EC_MODE Operation Mode
  ...
  * @{
  */
#define LL_PKA_MODE_MODULAR_EXP              ((uint32_t)0x00000000U)
#define LL_PKA_MODE_MONTGOMERY_PARAM         ((uint32_t)0x00000001U)
#define LL_PKA_MODE_MODULAR_EXP_FAST         ((uint32_t)0x00000002U)
#define LL_PKA_MODE_MODULAR_EXP_PROTECT      ((uint32_t)0x00000003U)
#define LL_PKA_MODE_ECC_MUL                  ((uint32_t)0x00000020U)
#define LL_PKA_MODE_ECC_COMPLETE_ADD         ((uint32_t)0x00000023U)
...
#define LL_PKA_MODE_DOUBLE_BASE_LADDER       ((uint32_t)0x00000027U)
#define LL_PKA_MODE_ECC_PROJECTIVE_AFF       ((uint32_t)0x0000002FU)
