...
/** @defgroup SYSTEM_LL_EC_ERASE_MEMORIES_STATUS SYSCFG MEMORIES ERASE STATUS
  * @{
  */
#define LL_SYSCFG_MEMORIES_ERASE_ON_GOING         0U
#define LL_SYSCFG_MEMORIES_ERASE_ENDED            SYSCFG_MESR_MCLR
/**
  * @}
  */
...
/** @defgroup SYSTEM_LL_EC_FASTMODEPLUS SYSCFG FASTMODEPLUS
  * @{
  */
#define LL_SYSCFG_FASTMODEPLUS_PB6     SYSCFG_CFGR1_PB6_FMP
#define LL_SYSCFG_FASTMODEPLUS_PB7     SYSCFG_CFGR1_PB7_FMP
#define LL_SYSCFG_FASTMODEPLUS_PB8     SYSCFG_CFGR1_PB8_FMP
#define LL_SYSCFG_FASTMODEPLUS_PB9     SYSCFG_CFGR1_PB9_FMP
/**
  * @}
  */
...
/** @defgroup SYSTEM_LL_DECOUPLING_CAPACITANCE SYSCFG DECOUPLING CAPACITANCE
  * @{
  */
#define LL_SYSCFG_HSPI_CAPACITANCE_OFF       0x00000000U
#define LL_SYSCFG_HSPI_CAPACITANCE_1_DIV_3   SYSCFG_CFGR1_ENDCAP_0
#define LL_SYSCFG_HSPI_CAPACITANCE_2_DIV_3   SYSCFG_CFGR1_ENDCAP_1
#define LL_SYSCFG_HSPI_CAPACITANCE_FULL      SYSCFG_CFGR1_ENDCAP
/**
  * @}
  */
...
/** @defgroup SYSTEM_LL_OTG_PHY_CLOCK_FREQUENCY SYSCFG OTG High-speed (HS) PHY reference clock frequency selection
  * @{
  */
#define LL_SYSCFG_OTGHSPHY_CLK_16MHZ    (SYSCFG_OTGHSPHYCR_CLKSEL_0 | SYSCFG_OTGHSPHYCR_CLKSEL_1)
#define LL_SYSCFG_OTGHSPHY_CLK_19_2MHZ  (SYSCFG_OTGHSPHYCR_CLKSEL_3)
#define LL_SYSCFG_OTGHSPHY_CLK_20MHZ    (SYSCFG_OTGHSPHYCR_CLKSEL_0 | SYSCFG_OTGHSPHYCR_CLKSEL_3)
#define LL_SYSCFG_OTGHSPHY_CLK_24MHZ    (SYSCFG_OTGHSPHYCR_CLKSEL_1 | SYSCFG_OTGHSPHYCR_CLKSEL_3)
...
/** @defgroup SYSTEM_LL_OTG_PHYTUNER_DISCONNECT_THRESTHOLD SYSCFG OTG High-speed (HS) PHYTUNER disconnnect threshold
  * @{
  */
#define LL_SYSCFG_OTGHSPHY_DISCONNECT_5_9PERCENT  SYSCFG_OTGHSPHYTUNER2_COMPDISTUNE_1
#define LL_SYSCFG_OTGHSPHY_DISCONNECT_0PERCENT    SYSCFG_OTGHSPHYTUNER2_COMPDISTUNE_0
/**
  * @}
  */
...
/** @defgroup SYSTEM_LL_OTG_SQUELSH SYSCFG OTG High-speed (HS) PHY Squelch threshold adjustment
  * @{
  */
#define LL_SYSCFG_OTGHSPHY_SQUELCH_15PERCENT  0x00000000U
#define LL_SYSCFG_OTGHSPHY_SQUELCH_0PERCENT   (SYSCFG_OTGHSPHYTUNER2_SQRXTUNE_0 | SYSCFG_OTGHSPHYTUNER2_SQRXTUNE_1)
/**
  * @}
  */
#endif /* SYSCFG_OTGHSPHYTUNER2_COMPDISTUNE */
...
/** @defgroup SYSTEM_LL_OTG_TRANSMITTER_PREEMPHASIS_CURRENT SYSCFG OTG High-speed (HS) transmitter preemphasis current control
  * @{
  */
#define LL_SYSCFG_OTGHSPHY_PREEMP_DISABLED  0x00000000U
#define LL_SYSCFG_OTGHSPHY_PREEMP_1X        SYSCFG_OTGHSPHYTUNER2_TXPREEMPAMPTUNE_0
#define LL_SYSCFG_OTGHSPHY_PREEMP_2X        SYSCFG_OTGHSPHYTUNER2_TXPREEMPAMPTUNE_1
...
/** @defgroup SYSCFG_Lock_items SYSCFG Lock items
  * @{
  */
#define LL_SYSCFG_MPU_NSEC        SYSCFG_CNSLCKR_LOCKNSMPU
#define LL_SYSCFG_VTOR_NSEC       SYSCFG_CNSLCKR_LOCKNSVTOR
#if defined (__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
#define LL_SYSCFG_SAU             (SYSCFG_CSLCKR_LOCKSAU << 16U)
#define LL_SYSCFG_MPU_SEC         (SYSCFG_CSLCKR_LOCKSMPU << 16U)
#define LL_SYSCFG_VTOR_AIRCR_SEC  (SYSCFG_CSLCKR_LOCKSVTAIRCR << 16U)
#define LL_SYSCFG_LOCK_ALL        (LL_SYSCFG_MPU_NSEC | LL_SYSCFG_VTOR_NSEC | LL_SYSCFG_SAU | LL_SYSCFG_MPU_SEC | \
                                   LL_SYSCFG_VTOR_AIRCR_SEC)
#else
#define LL_SYSCFG_LOCK_ALL        (LL_SYSCFG_MPU_NSEC | LL_SYSCFG_VTOR_NSEC)
...
/** @defgroup SYSTEM_LL_EC_SECURE_ATTRIBUTES Secure attributes
  ...
  * @{
  */
#define LL_SYSCFG_CLOCK_SEC                SYSCFG_SECCFGR_SYSCFGSEC
#define LL_SYSCFG_CLOCK_NSEC               0U
#define LL_SYSCFG_CLASSB_SEC               SYSCFG_SECCFGR_CLASSBSEC
#define LL_SYSCFG_CLASSB_NSEC              0U
#define LL_SYSCFG_FPU_SEC                  SYSCFG_SECCFGR_FPUSEC
#define LL_SYSCFG_FPU_NSEC                 0U
/**
  * @}
  */
...
/** @defgroup SYSTEM_LL_EC_APB1_GRP2_STOP_IP DBGMCU APB1 GRP2 STOP IP
  * @{
  */
#define LL_DBGMCU_APB1_GRP2_I2C4_STOP      DBGMCU_APB1FZR2_DBG_I2C4_STOP
#define LL_DBGMCU_APB1_GRP2_LPTIM2_STOP    DBGMCU_APB1FZR2_DBG_LPTIM2_STOP
#define LL_DBGMCU_APB1_GRP2_I2C5_STOP      DBGMCU_APB1FZR2_DBG_I2C5_STOP
#define LL_DBGMCU_APB1_GRP2_I2C6_STOP      DBGMCU_APB1FZR2_DBG_I2C6_STOP
/**
  * @}
  */
...
#define LL_DBGMCU_APB2_GRP1_TIM8_STOP      DBGMCU_APB2FZR_DBG_TIM8_STOP
#define LL_DBGMCU_APB2_GRP1_TIM15_STOP     DBGMCU_APB2FZR_DBG_TIM15_STOP
...
/** @defgroup SYSTEM_LL_EC_APB3_GRP1_STOP_IP DBGMCU APB3 GRP1 STOP IP
  * @{
  */
#define LL_DBGMCU_APB3_GRP1_I2C3_STOP      DBGMCU_APB3FZR_DBG_I2C3_STOP
#define LL_DBGMCU_APB3_GRP1_LPTIM1_STOP    DBGMCU_APB3FZR_DBG_LPTIM1_STOP
#define LL_DBGMCU_APB3_GRP1_LPTIM3_STOP    DBGMCU_APB3FZR_DBG_LPTIM3_STOP
#define LL_DBGMCU_APB3_GRP1_LPTIM4_STOP    DBGMCU_APB3FZR_DBG_LPTIM4_STOP
#define LL_DBGMCU_APB3_GRP1_RTC_STOP       DBGMCU_APB3FZR_DBG_RTC_STOP
/**
  * @}
  */
...
/** @defgroup SYSTEM_LL_EC_AHB1_GRP1_STOP_IP DBGMCU AHB1 GRP1 STOP IP
  * @{
  */
#define LL_DBGMCU_AHB1_GRP1_GPDMA0_STOP    DBGMCU_AHB1FZR_DBG_GPDMA0_STOP
#define LL_DBGMCU_AHB1_GRP1_GPDMA1_STOP    DBGMCU_AHB1FZR_DBG_GPDMA1_STOP
#define LL_DBGMCU_AHB1_GRP1_GPDMA2_STOP    DBGMCU_AHB1FZR_DBG_GPDMA2_STOP
#define LL_DBGMCU_AHB1_GRP1_GPDMA3_STOP    DBGMCU_AHB1FZR_DBG_GPDMA3_STOP
#define LL_DBGMCU_AHB1_GRP1_GPDMA4_STOP    DBGMCU_AHB1FZR_DBG_GPDMA4_STOP
#define LL_DBGMCU_AHB1_GRP1_GPDMA5_STOP    DBGMCU_AHB1FZR_DBG_GPDMA5_STOP
#define LL_DBGMCU_AHB1_GRP1_GPDMA6_STOP    DBGMCU_AHB1FZR_DBG_GPDMA6_STOP
#define LL_DBGMCU_AHB1_GRP1_GPDMA7_STOP    DBGMCU_AHB1FZR_DBG_GPDMA7_STOP
#define LL_DBGMCU_AHB1_GRP1_GPDMA8_STOP    DBGMCU_AHB1FZR_DBG_GPDMA8_STOP
#define LL_DBGMCU_AHB1_GRP1_GPDMA9_STOP    DBGMCU_AHB1FZR_DBG_GPDMA9_STOP
#define LL_DBGMCU_AHB1_GRP1_GPDMA10_STOP   DBGMCU_AHB1FZR_DBG_GPDMA10_STOP
#define LL_DBGMCU_AHB1_GRP1_GPDMA11_STOP   DBGMCU_AHB1FZR_DBG_GPDMA11_STOP
#define LL_DBGMCU_AHB1_GRP1_GPDMA12_STOP   DBGMCU_AHB1FZR_DBG_GPDMA12_STOP
#define LL_DBGMCU_AHB1_GRP1_GPDMA13_STOP   DBGMCU_AHB1FZR_DBG_GPDMA13_STOP
#define LL_DBGMCU_AHB1_GRP1_GPDMA14_STOP   DBGMCU_AHB1FZR_DBG_GPDMA14_STOP
#define LL_DBGMCU_AHB1_GRP1_GPDMA15_STOP   DBGMCU_AHB1FZR_DBG_GPDMA15_STOP
/**
  * @}
  */
...
/** @defgroup SYSTEM_LL_EC_AHB3_GRP1_STOP_IP DBGMCU AHB3 GRP1 STOP IP
  * @{
  */
#define LL_DBGMCU_AHB3_GRP1_LPDMA0_STOP    DBGMCU_AHB3FZR_DBG_LPDMA0_STOP
#define LL_DBGMCU_AHB3_GRP1_LPDMA1_STOP    DBGMCU_AHB3FZR_DBG_LPDMA1_STOP
#define LL_DBGMCU_AHB3_GRP1_LPDMA2_STOP    DBGMCU_AHB3FZR_DBG_LPDMA2_STOP
#define LL_DBGMCU_AHB3_GRP1_LPDMA3_STOP    DBGMCU_AHB3FZR_DBG_LPDMA3_STOP
/**
  * @}
  */
...
#define LL_VREFBUF_VOLTAGE_SCALE3          (VREFBUF_CSR_VRS_0 | VREFBUF_CSR_VRS_1)
/**
  * @}
  */
#endif /* VREFBUF */
