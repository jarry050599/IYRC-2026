...
#define PWR_SRAM1_PAGE4_STOP      (SRAM1_ID  | PAGE04_ID)
#define PWR_SRAM1_PAGE5_STOP      (SRAM1_ID  | PAGE05_ID)
#define PWR_SRAM1_PAGE6_STOP      (SRAM1_ID  | PAGE06_ID)
#define PWR_SRAM1_PAGE7_STOP      (SRAM1_ID  | PAGE07_ID)
#define PWR_SRAM1_PAGE8_STOP      (SRAM1_ID  | PAGE08_ID)
#define PWR_SRAM1_PAGE9_STOP      (SRAM1_ID  | PAGE09_ID)
#define PWR_SRAM1_PAGE10_STOP     (SRAM1_ID  | PAGE10_ID)
#define PWR_SRAM1_PAGE11_STOP     (SRAM1_ID  | PAGE11_ID)
#define PWR_SRAM1_PAGE12_STOP     (SRAM1_ID  | PAGE12_ID)
#define PWR_SRAM1_FULL_STOP       (SRAM1_ID  | 0x0FFFU)
#else
...
#define PWR_SRAM3_PAGE9_STOP      (SRAM3_ID  | PAGE09_ID)
#define PWR_SRAM3_PAGE10_STOP     (SRAM3_ID  | PAGE10_ID)
#define PWR_SRAM3_PAGE11_STOP     (SRAM3_ID  | PAGE11_ID)
#define PWR_SRAM3_PAGE12_STOP     (SRAM3_ID  | PAGE12_ID)
#define PWR_SRAM3_PAGE13_STOP     (SRAM3_ID  | PAGE13_ID)
#define PWR_SRAM3_FULL_STOP       (SRAM3_ID  | 0x1FFFU)
#else
...
#define PWR_SRAM5_PAGE1_STOP      (SRAM5_ID  | PAGE01_ID)
#define PWR_SRAM5_PAGE2_STOP      (SRAM5_ID  | PAGE02_ID)
#define PWR_SRAM5_PAGE3_STOP      (SRAM5_ID  | PAGE03_ID)
#define PWR_SRAM5_PAGE4_STOP      (SRAM5_ID  | PAGE04_ID)
#define PWR_SRAM5_PAGE5_STOP      (SRAM5_ID  | PAGE05_ID)
#define PWR_SRAM5_PAGE6_STOP      (SRAM5_ID  | PAGE06_ID)
#define PWR_SRAM5_PAGE7_STOP      (SRAM5_ID  | PAGE07_ID)
#define PWR_SRAM5_PAGE8_STOP      (SRAM5_ID  | PAGE08_ID)
#define PWR_SRAM5_PAGE9_STOP      (SRAM5_ID  | PAGE09_ID)
#define PWR_SRAM5_PAGE10_STOP     (SRAM5_ID  | PAGE10_ID)
#define PWR_SRAM5_PAGE11_STOP     (SRAM5_ID  | PAGE11_ID)
#define PWR_SRAM5_PAGE12_STOP     (SRAM5_ID  | PAGE12_ID)
#define PWR_SRAM5_PAGE13_STOP     (SRAM5_ID  | PAGE13_ID)
#define PWR_SRAM5_FULL_STOP       (SRAM5_ID  | 0x1FFFU)
#endif /* defined (PWR_CR4_SRAM5PDS1) */

#if defined (PWR_CR5_SRAM6PDS1)
/* SRAM5 pages retention defines */
#define PWR_SRAM6_PAGE1_STOP      (SRAM6_ID  | PAGE01_ID)
#define PWR_SRAM6_PAGE2_STOP      (SRAM6_ID  | PAGE02_ID)
#define PWR_SRAM6_PAGE3_STOP      (SRAM6_ID  | PAGE03_ID)
#define PWR_SRAM6_PAGE4_STOP      (SRAM6_ID  | PAGE04_ID)
#define PWR_SRAM6_PAGE5_STOP      (SRAM6_ID  | PAGE05_ID)
#define PWR_SRAM6_PAGE6_STOP      (SRAM6_ID  | PAGE06_ID)
#define PWR_SRAM6_PAGE7_STOP      (SRAM6_ID  | PAGE07_ID)
#define PWR_SRAM6_PAGE8_STOP      (SRAM6_ID  | PAGE08_ID)
#define PWR_SRAM6_FULL_STOP       (SRAM6_ID  | 0xFFU)
...
#define PWR_DCACHE2_FULL_STOP     (DCACHE2RAM_ID | PAGE01_ID)
...
#define PWR_SRAM5_FULL_RUN PWR_CR1_SRAM5PD
#endif /* defined (PWR_CR1_SRAM5PD) */
#if defined (PWR_CR1_SRAM6PD)
#define PWR_SRAM6_FULL_RUN PWR_CR1_SRAM6PD
