...
typedef enum _wm8962_sequence_id {
	kWM8962_SequenceDACToHeadphonePowerUp = 0x80U,
	kWM8962_SequenceAnalogueInputPowerUp = 0x92U,
	kWM8962_SequenceChipPowerDown = 0x9BU,
	kWM8962_SequenceSpeakerSleep = 0xE4U,
	kWM8962_SequenceSpeakerWake = 0xE8U,
