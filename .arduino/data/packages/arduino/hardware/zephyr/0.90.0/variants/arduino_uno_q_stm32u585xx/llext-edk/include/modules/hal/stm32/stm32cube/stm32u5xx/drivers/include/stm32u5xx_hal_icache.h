...
#define ICACHE_2WAYS                   ICACHE_CR_WAYSEL
/**
  * @}
  */
...
/** @defgroup ICACHE_Monitor_Type Monitor type
  * @{
  */
#define ICACHE_MONITOR_HIT_MISS        (ICACHE_CR_HITMEN | ICACHE_CR_MISSMEN)
#define ICACHE_MONITOR_HIT             ICACHE_CR_HITMEN
#define ICACHE_MONITOR_MISS            ICACHE_CR_MISSMEN
/**
  * @}
  */
...
/** @defgroup ICACHE_Region Remapped Region number
  * @{
  */
#define ICACHE_REGION_0                0U
#define ICACHE_REGION_1                1U
#define ICACHE_REGION_2                2U
#define ICACHE_REGION_3                3U
/**
  * @}
  */
...
/** @defgroup ICACHE_Region_Size Remapped Region size
  * @{
  */
#define ICACHE_REGIONSIZE_2MB          1U
#define ICACHE_REGIONSIZE_4MB          2U
#define ICACHE_REGIONSIZE_8MB          3U
#define ICACHE_REGIONSIZE_16MB         4U
#define ICACHE_REGIONSIZE_32MB         5U
#define ICACHE_REGIONSIZE_64MB         6U
#define ICACHE_REGIONSIZE_128MB        7U
/**
  * @}
  */
...
/** @defgroup ICACHE_Traffic_Route Remapped Traffic route
  * @{
  */
#define ICACHE_MASTER1_PORT            0U
#define ICACHE_MASTER2_PORT            ICACHE_CRRx_MSTSEL
/**
  * @}
  */
...
/** @defgroup ICACHE_Output_Burst_Type Remapped Output burst type
  * @{
  */
#define ICACHE_OUTPUT_BURST_WRAP       0U
#define ICACHE_OUTPUT_BURST_INCR       ICACHE_CRRx_HBURST
/**
  * @}
  */
...
/** @defgroup ICACHE_Interrupts Interrupts
  * @{
  */
#define ICACHE_IT_BUSYEND              ICACHE_IER_BSYENDIE
#define ICACHE_IT_ERROR                ICACHE_IER_ERRIE
/**
  * @}
  */
...
/** @defgroup ICACHE_Flags Flags
  * @{
  */
#define ICACHE_FLAG_BUSY               ICACHE_SR_BUSYF
#define ICACHE_FLAG_BUSYEND            ICACHE_SR_BSYENDF
#define ICACHE_FLAG_ERROR              ICACHE_SR_ERRF
/**
  * @}
  */
