...
#define GICDistributor_SGIR_INTID_Msk         (0xFU)
...
#define GICInterface_HPPIR_INTID_Msk        (0x3FFU)
...
#define PTIM_CONTROL_Enable_Msk             (0x1U)
#define PTIM_CONTROL_Enable(x)              (((uint32_t)(((uint32_t)(x)))) & PTIM_CONTROL_Enable_Msk)
...
#define PTIM_WCONTROL_Enable_Msk            (0x1U)
#define PTIM_WCONTROL_Enable(x)             (((uint32_t)(((uint32_t)(x)))) & PTIM_WCONTROL_Enable_Msk)
...
#define PTIM_WISR_EventFlag_Msk             (0x1U)
#define PTIM_WISR_EventFlag(x)              (((uint32_t)(((uint32_t)(x)))) & PTIM_WISR_EventFlag_Msk)

/* WRESET Watchdog Reset Status */
#define PTIM_WRESET_ResetFlag_Pos           0U
#define PTIM_WRESET_ResetFlag_Msk           (0x1U)
#define PTIM_WRESET_ResetFlag(x)            (((uint32_t)(((uint32_t)(x)))) & PTIM_WRESET_ResetFlag_Msk)
