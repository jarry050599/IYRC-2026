...
/** @defgroup SPI_AutonomousMode_TriggerSelection Autonomous Mode Trigger Selection
  * @{
  */
#define SPI_TRIG_GRP1                   (0x10000000U)
#if defined(SPI3)
#define SPI_TRIG_GRP2                   (0x20000000U)
...
/** @defgroup SPI_AutonomousMode_TriggerPolarity Autonomous Mode Trigger Polarity
  * @{
  */
#define SPI_TRIG_POLARITY_RISING        (0x00000000UL)
#define SPI_TRIG_POLARITY_FALLING       SPI_AUTOCR_TRIGPOL
/**
  * @}
  */
