...
#endif /* USE_HAL_MDF_REGISTER_CALLBACKS */
{
  ...
  __IO HAL_MDF_StateTypeDef  State;
  ...
  void (*AcqCpltCallback)(struct __MDF_HandleTypeDef *hmdf);
  void (*AcqHalfCpltCallback)(struct __MDF_HandleTypeDef *hmdf);
  ...
  void (*SadCallback)(struct __MDF_HandleTypeDef *hmdf);          /*!< MDF sound activity detector callback.
                                                                       @note Not used for MDF instance */
  void (*ErrorCallback)(struct __MDF_HandleTypeDef *hmdf);
  void (*MspInitCallback)(struct __MDF_HandleTypeDef *hmdf);
  void (*MspDeInitCallback)(struct __MDF_HandleTypeDef *hmdf);
#endif /* USE_HAL_MDF_REGISTER_CALLBACKS */
} MDF_HandleTypeDef;
...
typedef enum
{
  HAL_MDF_OLD_CB_ID              = 0x00U, /*!< MDF out-off limit detector callback ID.
                                               @note Not used for ADF instance */
  HAL_MDF_ACQ_COMPLETE_CB_ID     = 0x01U,
  HAL_MDF_ACQ_HALFCOMPLETE_CB_ID = 0x02U,
  HAL_MDF_SNDLVL_CB_ID           = 0x03U, /*!< MDF sound level callback ID.
                                               @note Not used for MDF instance */
  HAL_MDF_SAD_CB_ID              = 0x04U, /*!< MDF sound activity detector callback ID.
                                               @note Not used for MDF instance */
  HAL_MDF_ERROR_CB_ID            = 0x05U,
  HAL_MDF_MSPINIT_CB_ID          = 0x06U,
  HAL_MDF_MSPDEINIT_CB_ID        = 0x07U
...
/** @defgroup MDF_ErrorCode MDF error code
  * @{
  */
#define MDF_ERROR_NONE                  0x00000000U
#define MDF_ERROR_ACQUISITION_OVERFLOW  0x00000001U
#define MDF_ERROR_RSF_OVERRUN           0x00000002U
#define MDF_ERROR_CLOCK_ABSENCE         0x00000004U
#define MDF_ERROR_SHORT_CIRCUIT         0x00000008U /*!< Short circuit detection occurs.
                                                         @note Not used for ADF instance */
#define MDF_ERROR_SATURATION            0x00000010U
#define MDF_ERROR_OUT_OFF_LIMIT         0x00000020U /*!< Out-off limit detection occurs.
                                                         @note Not used for ADF instance */
#define MDF_ERROR_DMA                   0x00000040U
#if (USE_HAL_MDF_REGISTER_CALLBACKS == 1)
#define MDF_ERROR_INVALID_CALLBACK      0x00000080U
#endif /* USE_HAL_MDF_REGISTER_CALLBACKS */
/**
  * @}
  */
...
#define MDF_CLOCK_TRIG_TIM1_TRGO   MDF_CKGCR_TRGSRC_1
#define MDF_CLOCK_TRIG_TIM1_TRGO2 (MDF_CKGCR_TRGSRC_0 | \
                                   MDF_CKGCR_TRGSRC_1)
#define MDF_CLOCK_TRIG_TIM8_TRGO   MDF_CKGCR_TRGSRC_2
...
#define MDF_CLOCK_TRIG_TIM4_TRGO  (MDF_CKGCR_TRGSRC_0 | \
                                   MDF_CKGCR_TRGSRC_1 | \
                                   MDF_CKGCR_TRGSRC_2)
#define MDF_CLOCK_TRIG_TIM16_OC1   MDF_CKGCR_TRGSRC_3
...
#define MDF_CLOCK_TRIG_LPTIM1_OUT (MDF_CKGCR_TRGSRC_1 | \
                                   MDF_CKGCR_TRGSRC_2 | \
                                   MDF_CKGCR_TRGSRC_3)
#define MDF_CLOCK_TRIG_SAD_TRGO    MDF_CKGCR_TRGSRC
/**
  * @}
  */
...
/** @defgroup MDF_ClockTriggerEdge MDF output clock trigger edge
  * @{
  */
#define MDF_CLOCK_TRIG_RISING_EDGE   0x00000000U
#define MDF_CLOCK_TRIG_FALLING_EDGE  MDF_CKGCR_TRGSENS
/**
  * @}
  */
...
/** @defgroup MDF_OuputClockPins MDF output clock pins
  * @{
  */
#define MDF_OUTPUT_CLOCK_0    MDF_CKGCR_CCK0DIR
#define MDF_OUTPUT_CLOCK_1    MDF_CKGCR_CCK1DIR
...
/** @defgroup MDF_SitfMode MDF serial interface mode
  * @{
  */
#define MDF_SITF_LF_MASTER_SPI_MODE       0x00000000U
#define MDF_SITF_NORMAL_SPI_MODE          MDF_SITFCR_SITFMOD_0
...
/** @defgroup MDF_SitfClockSource MDF serial interface clock source
  * @{
  */
#define MDF_SITF_CCK0_SOURCE  0x00000000U
#define MDF_SITF_CCK1_SOURCE  MDF_SITFCR_SCKSRC_0
...
#define MDF_BITSTREAM1_RISING   MDF_BSMXCR_BSSEL_1
#define MDF_BITSTREAM1_FALLING (MDF_BSMXCR_BSSEL_0 | \
                                MDF_BSMXCR_BSSEL_1)
#if !defined(STM32U535xx) && !defined(STM32U545xx)
#define MDF_BITSTREAM2_RISING   MDF_BSMXCR_BSSEL_2
...
#define MDF_BITSTREAM3_FALLING (MDF_BSMXCR_BSSEL_0 | \
                                MDF_BSMXCR_BSSEL_1 | \
                                MDF_BSMXCR_BSSEL_2)
#define MDF_BITSTREAM4_RISING   MDF_BSMXCR_BSSEL_3
...
/** @defgroup MDF_ReshapeDecimationRatio MDF reshape filter decimation ratio
  * @{
  */
#define MDF_RSF_DECIMATION_RATIO_4  0x00000000U
#define MDF_RSF_DECIMATION_RATIO_1  MDF_DFLTRSFR_RSFLTD
/**
  * @}
  */
...
/** @defgroup MDF_HighPassCutOffFreq MDF high pass filter cut-off frequency
  * @{
  */
#define MDF_HPF_CUTOFF_0_000625FPCM  0x00000000U
#define MDF_HPF_CUTOFF_0_00125FPCM   MDF_DFLTRSFR_HPFC_0
#define MDF_HPF_CUTOFF_0_0025FPCM    MDF_DFLTRSFR_HPFC_1
#define MDF_HPF_CUTOFF_0_0095FPCM    MDF_DFLTRSFR_HPFC
/**
  * @}
  */
...
/** @defgroup MDF_IntegratorOutputDiv MDF integrator output division
  * @{
  */
#define MDF_INTEGRATOR_OUTPUT_DIV_128  0x00000000U
#define MDF_INTEGRATOR_OUTPUT_DIV_32   MDF_DFLTINTR_INTDIV_0
#define MDF_INTEGRATOR_OUTPUT_DIV_4    MDF_DFLTINTR_INTDIV_1
#define MDF_INTEGRATOR_OUTPUT_NO_DIV   MDF_DFLTINTR_INTDIV
/**
  * @}
  */
...
/** @defgroup MDF_SadMode MDF sound activity detector mode
  * @{
  */
#define MDF_SAD_VOICE_ACTIVITY_DETECTOR  0x00000000U
#define MDF_SAD_SOUND_DETECTOR           MDF_SADCR_SADMOD_0
#define MDF_SAD_AMBIENT_NOISE_DETECTOR   MDF_SADCR_SADMOD
/**
  * @}
  */
...
/** @defgroup MDF_SadFrameSize MDF sound activity detector frame size
  * @{
  */
#define MDF_SAD_8_PCM_SAMPLES    0x00000000U
#define MDF_SAD_16_PCM_SAMPLES   MDF_SADCR_FRSIZE_0
#define MDF_SAD_32_PCM_SAMPLES   MDF_SADCR_FRSIZE_1
#define MDF_SAD_64_PCM_SAMPLES  (MDF_SADCR_FRSIZE_0 | MDF_SADCR_FRSIZE_1)
#define MDF_SAD_128_PCM_SAMPLES  MDF_SADCR_FRSIZE_2
#define MDF_SAD_256_PCM_SAMPLES (MDF_SADCR_FRSIZE_0 | MDF_SADCR_FRSIZE_2)
#define MDF_SAD_512_PCM_SAMPLES  MDF_SADCR_FRSIZE
/**
  * @}
  */
...
/** @defgroup MDF_SadSoundTriggerEvent MDF sound activity detector trigger event
  * @{
  */
#define MDF_SAD_ENTER_DETECT       0x00000000U
#define MDF_SAD_ENTER_EXIT_DETECT  MDF_SADCR_DETCFG
/**
  * @}
  */
...
/** @defgroup MDF_SadDataMemoryTransfer MDF sound activity detector data memory transfer mode
  * @{
  */
#define MDF_SAD_NO_MEMORY_TRANSFER         0x00000000U
#define MDF_SAD_MEMORY_TRANSFER_IN_DETECT  MDF_SADCR_DATCAP_0
#define MDF_SAD_MEMORY_TRANSFER_ALWAYS     MDF_SADCR_DATCAP
/**
  * @}
  */
...
/** @defgroup MDF_SadHangoverWindow MDF sound activity detector data hangover time window
  * @{
  */
#define MDF_SAD_HANGOVER_4_FRAMES    0x00000000U
#define MDF_SAD_HANGOVER_8_FRAMES    MDF_SADCFGR_HGOVR_0
#define MDF_SAD_HANGOVER_16_FRAMES   MDF_SADCFGR_HGOVR_1
#define MDF_SAD_HANGOVER_32_FRAMES  (MDF_SADCFGR_HGOVR_0 | \
                                     MDF_SADCFGR_HGOVR_1)
#define MDF_SAD_HANGOVER_64_FRAMES   MDF_SADCFGR_HGOVR_2
...
/** @defgroup MDF_SadLearningFrames MDF sound activity detector data learning frames
  * @{
  */
#define MDF_SAD_LEARNING_2_FRAMES   0x00000000U
#define MDF_SAD_LEARNING_4_FRAMES   MDF_SADCFGR_LFRNB_0
#define MDF_SAD_LEARNING_8_FRAMES   MDF_SADCFGR_LFRNB_1
#define MDF_SAD_LEARNING_16_FRAMES (MDF_SADCFGR_LFRNB_0 | MDF_SADCFGR_LFRNB_1)
#define MDF_SAD_LEARNING_32_FRAMES  MDF_SADCFGR_LFRNB
/**
  * @}
  */
...
/** @defgroup MDF_SadSignalNoiseThreshold MDF sound activity detector data signal to noise threshold
  * @{
  */
#define MDF_SAD_SIGNAL_NOISE_3_5DB   0x00000000U
#define MDF_SAD_SIGNAL_NOISE_6DB     MDF_SADCFGR_SNTHR_0
#define MDF_SAD_SIGNAL_NOISE_9_5DB   MDF_SADCFGR_SNTHR_1
#define MDF_SAD_SIGNAL_NOISE_12DB   (MDF_SADCFGR_SNTHR_0 | \
                                     MDF_SADCFGR_SNTHR_1)
#define MDF_SAD_SIGNAL_NOISE_15_6DB  MDF_SADCFGR_SNTHR_2
...
#define MDF_SAD_SIGNAL_NOISE_24_1DB (MDF_SADCFGR_SNTHR_0 | \
                                     MDF_SADCFGR_SNTHR_1 | \
                                     MDF_SADCFGR_SNTHR_2)
#define MDF_SAD_SIGNAL_NOISE_27_6DB  MDF_SADCFGR_SNTHR_3
...
#define MDF_FILTER_TRIG_OLD_EVENT    MDF_DFLTCR_TRGSRC_0
#define MDF_FILTER_TRIG_TIM1_TRGO    MDF_DFLTCR_TRGSRC_1
#define MDF_FILTER_TRIG_TIM1_TRGO2  (MDF_DFLTCR_TRGSRC_0 | \
                                     MDF_DFLTCR_TRGSRC_1)
#define MDF_FILTER_TRIG_TIM8_TRGO    MDF_DFLTCR_TRGSRC_2
...
#define MDF_FILTER_TRIG_TIM4_TRGO   (MDF_DFLTCR_TRGSRC_0 | \
                                     MDF_DFLTCR_TRGSRC_1 | \
                                     MDF_DFLTCR_TRGSRC_2)
#define MDF_FILTER_TRIG_TIM16_OC1    MDF_DFLTCR_TRGSRC_3
...
#define MDF_FILTER_TRIG_LPTIM1_OUT  (MDF_DFLTCR_TRGSRC_1 | \
                                     MDF_DFLTCR_TRGSRC_2 | \
                                     MDF_DFLTCR_TRGSRC_3)
#define MDF_FILTER_TRIG_ADF_TRGO     MDF_DFLTCR_TRGSRC
/**
  * @}
  */
...
/** @defgroup MDF_FilterTriggerEdge MDF filter trigger edge
  * @{
  */
#define MDF_FILTER_TRIG_RISING_EDGE   0x00000000U
#define MDF_FILTER_TRIG_FALLING_EDGE  MDF_DFLTCR_TRGSENS
/**
  * @}
  */
...
/** @defgroup MDF_DataSource MDF data source
  * @{
  */
#define MDF_DATA_SOURCE_BSMX     0x00000000U
...
#define MDF_TWO_FILTERS_MCIC_SINC3    (MDF_DFLTCICR_CICMOD_0 | \
                                       MDF_DFLTCICR_CICMOD_1)     /*!< Two filters, main filter in Sinc3 order.
                                                                       @note Not available for ADF instance */
#define MDF_ONE_FILTER_SINC4           MDF_DFLTCICR_CICMOD_2
#define MDF_ONE_FILTER_SINC5          (MDF_DFLTCICR_CICMOD_0 | \
                                       MDF_DFLTCICR_CICMOD_2)
/**
  * @}
  */
...
/** @defgroup MDF_AcquisitionMode MDF acquisition mode
  * @{
  */
#define MDF_MODE_ASYNC_CONT     0x00000000U
...
#define MDF_MODE_SYNC_CONT      MDF_DFLTCR_ACQMOD_1
...
/** @defgroup MDF_FifoThreshold MDF RXFIFO threshold
  * @{
  */
#define MDF_FIFO_THRESHOLD_NOT_EMPTY  0x00000000U
#define MDF_FIFO_THRESHOLD_HALF_FULL  MDF_DFLTCR_FTH
/**
  * @}
  */
...
#define MDF_SNAPSHOT_16BITS  MDF_DFLTCR_SNPSFMT
/**
  * @}
  */
...
/** @defgroup MDF_BreakSignals MDF break signals
  * @{
  */
#define MDF_NO_BREAK_SIGNAL     0x00000000U
#define MDF_TIM1_BREAK_SIGNAL   0x00000001U
#define MDF_TIM1_BREAK2_SIGNAL  0x00000002U
#define MDF_TIM8_BREAK_SIGNAL   0x00000004U
#define MDF_TIM8_BREAK2_SIGNAL  0x00000008U
/**
  * @}
  */
...
/** @defgroup MDF_OldCicMode MDF out-off limit detector CIC mode
  * @{
  */
#define MDF_OLD_FILTER_FASTSINC  0x00000000U
#define MDF_OLD_FILTER_SINC1     MDF_OLDCR_ACICN_0
#define MDF_OLD_FILTER_SINC2     MDF_OLDCR_ACICN_1
#define MDF_OLD_FILTER_SINC3     MDF_OLDCR_ACICN
/**
  * @}
  */
...
/** @defgroup MDF_OldThresholdInfo MDF out-off limit detector threshold information
  * @{
  */
#define MDF_OLD_IN_THRESHOLDS   0x00000000U
