...
#define LL_OPAMP_POWERSUPPLY_RANGE_HIGH (OPAMP_CSR_OPARANGE)
/**
  * @}
  */
...
/** @defgroup OPAMP_LL_EC_POWERMODE OPAMP power mode
  * @{
  */
#define LL_OPAMP_POWERMODE_NORMALPOWER_NORMALSPEED        0x00000000U
#define LL_OPAMP_POWERMODE_LOWPOWER_NORMALSPEED           OPAMP_CSR_OPALPM
#define LL_OPAMP_POWERMODE_NORMALPOWER_HIGHSPEED          OPAMP_CSR_HSM
#define LL_OPAMP_POWERMODE_LOWPOWER_HIGHSPEED            (OPAMP_CSR_OPALPM | OPAMP_CSR_HSM)
/**
  * @}
  */
...
/** @defgroup OPAMP_LL_EC_MODE_PGA_GAIN OPAMP PGA gain (relevant when OPAMP is in functional mode PGA)
  * @{
  */
#define LL_OPAMP_PGA_GAIN_2             0x00000000U
#define LL_OPAMP_PGA_GAIN_4             (OPAMP_CSR_PGA_GAIN_0)
#define LL_OPAMP_PGA_GAIN_8             (OPAMP_CSR_PGA_GAIN_1)
#define LL_OPAMP_PGA_GAIN_16            (OPAMP_CSR_PGA_GAIN_1 | OPAMP_CSR_PGA_GAIN_0)
/**
  * @}
  */
...
#define LL_OPAMP_INPUT_NONINVERT_DAC       (OPAMP_CSR_VP_SEL)
/**
  * @}
  */
...
#define LL_OPAMP_INPUT_INVERT_IO1         (OPAMP_CSR_VM_SEL_0)
#define LL_OPAMP_INPUT_INVERT_CONNECT_NO  (OPAMP_CSR_VM_SEL_1)
/**
  * @}
  */
...
#define LL_OPAMP_TRIMMING_PMOS          (OPAMP_OTR_TRIMOFFSETP | OPAMP_CSR_CALSEL)
/**
  * @}
  */
