...
#define IRQ_MODE_TRIG_Msk           (0x07UL)
...
#define IRQ_MODE_TRIG_EDGE          (0x04UL) ///< Trigger: edge triggered interrupt
#define IRQ_MODE_TRIG_EDGE_RISING   (0x05UL) ///< Trigger: rising edge triggered interrupt
#define IRQ_MODE_TRIG_EDGE_FALLING  (0x06UL) ///< Trigger: falling edge triggered interrupt
#define IRQ_MODE_TRIG_EDGE_BOTH     (0x07UL) ///< Trigger: rising and falling edge triggered interrupt
