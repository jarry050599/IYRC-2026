...
#endif /* (USE_HAL_RTC_REGISTER_CALLBACKS) */
{
  ...
  void (* SSRUEventCallback)(struct __RTC_HandleTypeDef *hrtc);
  ...
  void (* Tamper4EventCallback)(struct __RTC_HandleTypeDef *hrtc);
  void (* Tamper5EventCallback)(struct __RTC_HandleTypeDef *hrtc);
  void (* Tamper6EventCallback)(struct __RTC_HandleTypeDef *hrtc);
  void (* Tamper7EventCallback)(struct __RTC_HandleTypeDef *hrtc);
  void (* Tamper8EventCallback)(struct __RTC_HandleTypeDef *hrtc);
  ...
  void (* InternalTamper7EventCallback)(struct __RTC_HandleTypeDef *hrtc);
  void (* InternalTamper8EventCallback)(struct __RTC_HandleTypeDef *hrtc);
  void (* InternalTamper9EventCallback)(struct __RTC_HandleTypeDef *hrtc);
  void (* InternalTamper11EventCallback)(struct __RTC_HandleTypeDef *hrtc);
  void (* InternalTamper12EventCallback)(struct __RTC_HandleTypeDef *hrtc);
  void (* InternalTamper13EventCallback)(struct __RTC_HandleTypeDef *hrtc);
...
typedef enum
{
  ...
  HAL_RTC_SSRU_EVENT_CB_ID                = 4U,
  HAL_RTC_TAMPER1_EVENT_CB_ID             = 5U,
  HAL_RTC_TAMPER2_EVENT_CB_ID             = 6U,
  HAL_RTC_TAMPER3_EVENT_CB_ID             = 7U,
  HAL_RTC_TAMPER4_EVENT_CB_ID             = 8U,
  HAL_RTC_TAMPER5_EVENT_CB_ID             = 9U,
  HAL_RTC_TAMPER6_EVENT_CB_ID             = 10U,
  HAL_RTC_TAMPER7_EVENT_CB_ID             = 11U,
  HAL_RTC_TAMPER8_EVENT_CB_ID             = 12U,
  HAL_RTC_INTERNAL_TAMPER1_EVENT_CB_ID    = 13U,
  HAL_RTC_INTERNAL_TAMPER2_EVENT_CB_ID    = 14U,
  HAL_RTC_INTERNAL_TAMPER3_EVENT_CB_ID    = 15U,
  HAL_RTC_INTERNAL_TAMPER5_EVENT_CB_ID    = 16U,
  HAL_RTC_INTERNAL_TAMPER6_EVENT_CB_ID    = 17U,
  HAL_RTC_INTERNAL_TAMPER7_EVENT_CB_ID    = 18U,
  HAL_RTC_INTERNAL_TAMPER8_EVENT_CB_ID    = 19U,
  HAL_RTC_INTERNAL_TAMPER9_EVENT_CB_ID    = 20U,
  HAL_RTC_INTERNAL_TAMPER11_EVENT_CB_ID   = 21U,
  HAL_RTC_INTERNAL_TAMPER12_EVENT_CB_ID   = 22U,
  HAL_RTC_INTERNAL_TAMPER13_EVENT_CB_ID   = 23U,
  HAL_RTC_MSPINIT_CB_ID                   = 24U,
  HAL_RTC_MSPDEINIT_CB_ID                 = 25U
...
#define RTC_IT_SSRU                         RTC_CR_SSRUIE
...
#define RTC_FLAG_SSRUF                      (0x00000200U | RTC_SR_SSRUF_Pos)
...
/** @defgroup RTC_Clear_Flags_Definitions RTC Clear Flags Definitions
  * @{
  */
#define RTC_CLEAR_SSRUF                     RTC_SCR_CSSRUF
