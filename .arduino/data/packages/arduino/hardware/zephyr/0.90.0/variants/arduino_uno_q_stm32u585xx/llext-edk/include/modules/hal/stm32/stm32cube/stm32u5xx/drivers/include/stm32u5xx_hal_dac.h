...
#define DAC_TRIGGER_LPTIM1_CH1          (DAC_CR_TSEL1_3 |                  DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 | DAC_CR_TEN1)
#define DAC_TRIGGER_LPTIM3_CH1          (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2                                   | DAC_CR_TEN1)
...
/** @defgroup DAC_AutonomousMode DAC Autonomous Mode
  ...
  * @{
  */
#define DAC_AUTONOMOUS_MODE_DISABLE  0x00000000U
#define DAC_AUTONOMOUS_MODE_ENABLE   DAC_AUTOCR_AUTOMODE
/**
  * @}
  */
...
/** @defgroup DAC_Trigger_Stop_mode DAC Trigger Stop Mode
  ...
  * @{
  */
#define DAC_TRIGGER_STOP_LPTIM1_CH1 DAC_TRIGGER_LPTIM1_CH1
#define DAC_TRIGGER_STOP_LPTIM3_CH1 DAC_TRIGGER_LPTIM3_CH1
#define DAC_TRIGGER_STOP_EXT_IT9    DAC_TRIGGER_EXT_IT9
/**
  * @}
  */
