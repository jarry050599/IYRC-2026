...
typedef enum
{
  HAL_OPAMP_MSP_INIT_CB_ID                     = 0x01U,
  HAL_OPAMP_MSP_DEINIT_CB_ID                   = 0x02U,
...
#define OPAMP_NONINVERTINGINPUT_DAC_CH      OPAMP_CSR_VP_SEL
/**
  * @}
  */
...
#define OPAMP_INVERTINGINPUT_IO1              OPAMP_CSR_VM_SEL_0
#define OPAMP_INVERTINGINPUT_CONNECT_NO       OPAMP_CSR_VM_SEL_1
/**
  * @}
  */
...
#define OPAMP_PGA_GAIN_4                OPAMP_CSR_PGA_GAIN_0
#define OPAMP_PGA_GAIN_8                OPAMP_CSR_PGA_GAIN_1
#define OPAMP_PGA_GAIN_16              (OPAMP_CSR_PGA_GAIN_0 | OPAMP_CSR_PGA_GAIN_1)
...
/** @defgroup OPAMP_PowerMode OPAMP PowerMode
  * @{
  */
#define OPAMP_POWERMODE_NORMALPOWER_NORMALSPEED        0x00000000U
#define OPAMP_POWERMODE_LOWPOWER_NORMALSPEED           OPAMP_CSR_OPALPM
#define OPAMP_POWERMODE_NORMALPOWER_HIGHSPEED          OPAMP_CSR_HSM
#define OPAMP_POWERMODE_LOWPOWER_HIGHSPEED            (OPAMP_CSR_OPALPM | OPAMP_CSR_HSM)
...
#define OPAMP_POWERSUPPLY_HIGH         OPAMP_CSR_OPARANGE
