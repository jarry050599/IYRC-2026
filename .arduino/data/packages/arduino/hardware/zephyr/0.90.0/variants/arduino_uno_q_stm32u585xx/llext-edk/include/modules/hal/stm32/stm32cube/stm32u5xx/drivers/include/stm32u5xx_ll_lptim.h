...
{
  LPTIM_CCMR1_CC1E_Pos,
  LPTIM_CCMR1_CC2E_Pos
};
...
/** @defgroup LPTIM_LL_EC_GET_FLAG Get Flags Defines
  ...
  * @{
  */
#define LL_LPTIM_ISR_CMP1OK                   LPTIM_ISR_CMP1OK
#define LL_LPTIM_ISR_CMP2OK                   LPTIM_ISR_CMP2OK
#define LL_LPTIM_ISR_CC1IF                    LPTIM_ISR_CC1IF
#define LL_LPTIM_ISR_CC2IF                    LPTIM_ISR_CC2IF
#define LL_LPTIM_ISR_CC1OF                    LPTIM_ISR_CC1OF
#define LL_LPTIM_ISR_CC2OF                    LPTIM_ISR_CC2OF
#define LL_LPTIM_ISR_DIEROK                   LPTIM_ISR_DIEROK
...
#define LL_LPTIM_ISR_UE                       LPTIM_ISR_UE
#define LL_LPTIM_ISR_REPOK                    LPTIM_ISR_REPOK
/**
  * @}
  */
...
/** @defgroup LPTIM_LL_EC_IT IT Defines
  ...
  * @{
  */
#define LL_LPTIM_DIER_CMP1OKIE                 LPTIM_DIER_CMP1OKIE
#define LL_LPTIM_DIER_CMP2OKIE                 LPTIM_DIER_CMP2OKIE
#define LL_LPTIM_DIER_CC1IFIE                  LPTIM_DIER_CC1IE
#define LL_LPTIM_DIER_CC2IFIE                  LPTIM_DIER_CC2IE
#define LL_LPTIM_DIER_CC1OFIE                  LPTIM_DIER_CC1OIE
#define LL_LPTIM_DIER_CC2OFIE                  LPTIM_DIER_CC2OIE
#define LL_LPTIM_DIER_ARRMIE                   LPTIM_DIER_ARRMIE
#define LL_LPTIM_DIER_EXTTRIGIE                LPTIM_DIER_EXTTRIGIE
#define LL_LPTIM_DIER_ARROKIE                  LPTIM_DIER_ARROKIE
#define LL_LPTIM_DIER_UPIE                     LPTIM_DIER_UPIE
#define LL_LPTIM_DIER_DOWNIE                   LPTIM_DIER_DOWNIE
#define LL_LPTIM_DIER_UEIE                     LPTIM_DIER_UEIE
#define LL_LPTIM_DIER_REPOKIE                  LPTIM_DIER_REPOKIE
/**
  * @}
  */
...
#define LL_LPTIM_OUTPUT_POLARITY_INVERSE      LPTIM_CCMR1_CC1P_0
/**
  * @}
  */
...
/** @defgroup TIM_LL_EC_CHANNEL Channel
  * @{
  */
#define LL_LPTIM_CHANNEL_CH1                  0x00000000U
#define LL_LPTIM_CHANNEL_CH2                  0x00000001U
/**
  * @}
  */
...
/** @defgroup LPTIM_LL_EC_LPTIM_IC_PRESCALER Input Capture Prescaler
  * @{
  */
#define LL_LPTIM_ICPSC_DIV1                   0x00000000UL
#define LL_LPTIM_ICPSC_DIV2                   LPTIM_CCMR1_IC1PSC_0
#define LL_LPTIM_ICPSC_DIV4                   LPTIM_CCMR1_IC1PSC_1
#define LL_LPTIM_ICPSC_DIV8                   (LPTIM_CCMR1_IC1PSC_0|LPTIM_CCMR1_IC1PSC_1)
/**
  * @}
  */
...
/** @defgroup LPTIM_LL_EC_LPTIM_IC_FILTER Input Capture Filter
  * @{
  */
#define LL_LPTIM_ICFLT_CLOCK_DIV1             0x00000000UL
#define LL_LPTIM_ICFLT_CLOCK_DIV2             LPTIM_CCMR1_IC1F_0
#define LL_LPTIM_ICFLT_CLOCK_DIV4             LPTIM_CCMR1_IC1F_1
#define LL_LPTIM_ICFLT_CLOCK_DIV8             (LPTIM_CCMR1_IC1F_0|LPTIM_CCMR1_IC1F_1)
/**
  * @}
  */
...
/** @defgroup LPTIM_LL_EC_LPTIM_IC_POLARITY  Input Capture Polarity
  * @{
  */
#define LL_LPTIM_ICPOLARITY_RISING            0x00000000UL
#define LL_LPTIM_ICPOLARITY_FALLING           LPTIM_CCMR1_CC1P_0
#define LL_LPTIM_ICPOLARITY_RISING_FALLING    (LPTIM_CCMR1_CC1P_0|LPTIM_CCMR1_CC1P_1)
/**
  * @}
  */
/** @defgroup LPTIM_LL_EC_LPTIM_IC_Selection  Input Capture selection
  * @{
  */
#define LL_LPTIM_CCMODE_OUTPUT_PWM            0x00000000UL
#define LL_LPTIM_CCMODE_INPUTCAPTURE          LPTIM_CCMR1_CC1SEL
/**
  * @}
  */
...
#endif /* COMP2 */
#define LL_LPTIM_TRIG_SOURCE_LPDMA_CH0_TCF    (LPTIM_CFGR_TRIGSEL_1 | LPTIM_CFGR_TRIGSEL_0)
#define LL_LPTIM_TRIG_SOURCE_LPDMA_CH1_TCF    LPTIM_CFGR_TRIGSEL_2
#define LL_LPTIM_TRIG_SOURCE_LPDMA_CH2_TCF    (LPTIM_CFGR_TRIGSEL_2 | LPTIM_CFGR_TRIGSEL_0)
#define LL_LPTIM_TRIG_SOURCE_GPDMA_CH0_TCF    LPTIM_CFGR_TRIGSEL_2
#define LL_LPTIM_TRIG_SOURCE_GPDMA_CH4_TCF    (LPTIM_CFGR_TRIGSEL_2 | LPTIM_CFGR_TRIGSEL_0)
/**
  * @}
  */
...
/** @defgroup LPTIM_EC_LPTIM1_IC1_RMP LPTIM1 Input Ch1 Remap
  * @{
  */
#define LL_LPTIM_LPTIM1_IC1_RMP_GPIO     0x00000000UL
#define LL_LPTIM_LPTIM1_IC1_RMP_COMP1    LPTIM_CFGR2_IC1SEL_0
#if defined(COMP2)
#define LL_LPTIM_LPTIM1_IC1_RMP_COMP2    LPTIM_CFGR2_IC1SEL_1
#endif /* COMP2 */
/**
  * @}
  */
...
/** @defgroup LPTIM_EC_LPTIM1_IC2_RMP LPTIM1 Input Ch2 Remap
  * @{
  */
#define LL_LPTIM_LPTIM1_IC2_RMP_GPIO     0x00000000UL
#define LL_LPTIM_LPTIM1_IC2_RMP_LSI      LPTIM_CFGR2_IC2SEL_0
#define LL_LPTIM_LPTIM1_IC2_RMP_LSE      LPTIM_CFGR2_IC2SEL_1
/**
  * @}
  */
...
/** @defgroup LPTIM_EC_LPTIM2_IC1_RMP LPTIM2 Input Ch1 Remap
  * @{
  */
#define LL_LPTIM_LPTIM2_IC1_RMP_GPIO     0x00000000UL
#define LL_LPTIM_LPTIM2_IC1_RMP_COMP1    LPTIM_CFGR2_IC1SEL_0
#if defined(COMP2)
#define LL_LPTIM_LPTIM2_IC1_RMP_COMP2    LPTIM_CFGR2_IC1SEL_1
#endif /* COMP2 */
/**
  * @}
  */
...
/** @defgroup LPTIM_EC_LPTIM2_IC2_RMP LPTIM2 Input Ch2 Remap
  * @{
  */
#define LL_LPTIM_LPTIM2_IC2_RMP_GPIO     0x00000000UL
#define LL_LPTIM_LPTIM2_IC2_RMP_HSI      LPTIM_CFGR2_IC2SEL_0
#define LL_LPTIM_LPTIM2_IC2_RMP_MSIS_1024 LPTIM_CFGR2_IC2SEL_1
#define LL_LPTIM_LPTIM2_IC2_RMP_MSIS_4    (LPTIM_CFGR2_IC2SEL_1|LPTIM_CFGR2_IC2SEL_0)
/**
  * @}
  */
